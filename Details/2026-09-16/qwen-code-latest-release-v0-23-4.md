# Qwen Code latest release v0.23.4

> 日期：2026-09-16
> 类型：GitHub Release / Tool Changelog
> 原文：https://github.com/QwenLM/qwen-code/releases/tag/v0.23.4
...
## TL;DR
- 来源：Qwen Code
- 价值：关注 Qwen Code 是否改变 agent mode、MCP、IDE/CLI、权限模式、上下文窗口或 rate limit；发布时间/Tag：2026-09-14 / v0.23.4。
...
| 日期 | 2026-09-16 |
| 原文链接 | https://github.com/QwenLM/qwen-code/releases/tag/v0.23.4 |
...
flowchart TB
  subgraph Source[来源]
    A[Qwen Code] --> B[GitHub Release / Tool Changelog]
  end
...
## 专业解读
关注 Qwen Code 是否改变 agent mode、MCP、IDE/CLI、权限模式、上下文窗口或 rate limit；发布时间/Tag：2026-09-14 / v0.23.4。
