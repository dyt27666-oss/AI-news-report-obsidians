# Cline latest release desktop-v0.0.28

> 日期：2026-09-16
> 类型：GitHub Release / Tool Changelog
> 原文：https://github.com/cline/cline/releases/tag/desktop-v0.0.28
...
## TL;DR
- 来源：Cline
- 价值：关注 Cline 是否改变 agent mode、MCP、IDE/CLI、权限模式、上下文窗口或 rate limit；发布时间/Tag：2026-09-15 / desktop-v0.0.28。
...
|---|---|
| 来源 | Cline |
| 来源类型 | GitHub Release / Tool Changelog |
| 日期 | 2026-09-16 |
| 原文链接 | https://github.com/cline/cline/releases/tag/desktop-v0.0.28 |
...
flowchart TB
  subgraph Source[来源]
    A[Cline] --> B[GitHub Release / Tool Changelog]
  end
...
## 专业解读
关注 Cline 是否改变 agent mode、MCP、IDE/CLI、权限模式、上下文窗口或 rate limit；发布时间/Tag：2026-09-15 / desktop-v0.0.28。
