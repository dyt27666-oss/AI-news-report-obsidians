# Continue latest release v2.0.0-vscode
...
## TL;DR
- 来源：Continue
- 价值：关注 Continue 是否改变 agent mode、MCP、IDE/CLI、权限模式、上下文窗口或 rate limit；发布时间/Tag：2026-06-19 / v2.0.0-vscode。
...
flowchart TB
  subgraph Source[来源]
    A[Continue] --> B[GitHub Release / Tool Changelog]
  end
...
## 专业解读
关注 Continue 是否改变 agent mode、MCP、IDE/CLI、权限模式、上下文窗口或 rate limit；发布时间/Tag：2026-06-19 / v2.0.0-vscode。
