# Continue - Latest release v2.0.0-vscode（2026-06-19）

> 一句话结论：Continue - Latest release v2.0.0-vscode（2026-06-19） 是今日 AI Radar 中的Coding 工具更新信号，适合先作为工程/研究观察点，而不是盲目投入。
...
| 功能变化 | Latest release v2.0.0-vscode（2026-06-19） |
| 发布时间/release tag | Latest release v2.0.0-vscode（2026-06-19） |
