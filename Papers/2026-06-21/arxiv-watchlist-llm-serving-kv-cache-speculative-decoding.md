# arXiv Watchlist: LLM serving / KV cache / speculative decoding

> 类型：论文观察卡
> 大类：论文
> 小类：Serving / Inference
> 推荐等级：低置信
> 创建日期：2026-06-21
> 原文链接：https://export.arxiv.org/api/query
> PDF：未核验
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Papers/2026-06-21/arxiv-watchlist-llm-serving-kv-cache-speculative-decoding.md
> 返回日报：[[Daily/2026-06-21]]

## 一句话结论

今日 arXiv API 多次 429/timeout，未能可靠核验新论文；保留 serving 查询作为低置信 watchlist。

## TL;DR

- **研究问题**：Serving / Inference 方向是否出现新方法。
...
| 论文来源 | arXiv |
| 来源类型 | 预印本索引 / 今日访问失败 |
| 标题 | arXiv Watchlist: LLM serving / KV cache / speculative decoding |
| 作者/机构 | 未核验 |
| 发布时间 | 未核验 |
