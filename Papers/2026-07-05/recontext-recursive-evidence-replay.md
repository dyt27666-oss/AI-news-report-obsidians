...
> 类型：论文  
> 大类：论文  
> 小类：Long Context / Harness Engineering  
> 推荐等级：必读  
> 创建日期：2026-07-05  
> 原文链接：https://arxiv.org/abs/2607.02509v1  
> PDF：https://arxiv.org/pdf/2607.02509v1  
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Papers/2026-07-05/recontext-recursive-evidence-replay.md  
> 返回日报：[[Daily/2026-07-05]]

## 一句话结论

ReContext 的“证据回放”方向适合转化为长上下文 agent harness：不仅看答案，还看模型是否真的使用了证据。

## TL;DR

- **研究问题**：Understanding and reasoning over long contexts has become a key requirement for deploying large language models in realistic applications.
...
| 作者/机构 | Yanjun Zhao, Ruizhong Qiu, Tianxin Wei, Yuanchen Bei |
| 发布时间 | 2026-07-02 |
| arXiv | [abs](https://arxiv.org/abs/2607.02509v1) |
| OpenReview / 会议页 | 未发现 |
| Semantic Scholar | 待补充 |
| PDF | [pdf](https://arxiv.org/pdf/2607.02509v1) |
| 代码 | 未发现 |
| 方向 | Long Context / Harness Engineering |
...
flowchart TB
  subgraph Q[1. 研究问题]
    Q1[目标: Long Context / Harness Engineering]
...
- 原文：https://arxiv.org/abs/2607.02509v1
- PDF：https://arxiv.org/pdf/2607.02509v1
- 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Papers/2026-07-05/recontext-recursive-evidence-replay.md
- 代码：未发现
