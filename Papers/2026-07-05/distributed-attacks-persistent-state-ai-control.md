...
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Papers/2026-07-05/distributed-attacks-persistent-state-ai-control.md  
> 返回日报：[[Daily/2026-07-05]]

## 一句话结论

这篇论文把 coding agent 的持久状态变成安全问题，直接对应多轮代码修改、prompt injection 和跨 session 审计。

## TL;DR

- **研究问题**：As AI coding agents become more autonomous, they increasingly ship code iteratively, with the codebase persisting across sessions.
...
| 发布时间 | 2026-07-02 |
| arXiv | [abs](https://arxiv.org/abs/2607.02514v1) |
| OpenReview / 会议页 | 未发现 |
| Semantic Scholar | 待补充 |
| PDF | [pdf](https://arxiv.org/pdf/2607.02514v1) |
| 代码 | 未发现 |
| 方向 | Agent Eval / Coding Agent Safety |
...
flowchart TB
  subgraph Q[1. 研究问题]
    Q1[目标: Agent Eval / Coding Agent Safety]
...
- 原文：https://arxiv.org/abs/2607.02514v1
- PDF：https://arxiv.org/pdf/2607.02514v1
- 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Papers/2026-07-05/distributed-attacks-persistent-state-ai-control.md
- 代码：未发现
