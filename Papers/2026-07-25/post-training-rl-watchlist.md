# Post-training RL / RLHF / GRPO 最新论文扫描
...
> 推荐等级：低置信
> 创建日期：2026-07-25
> 原文链接：https://export.arxiv.org/api/query?search_query=all:reinforcement+learning+language+models+post+training&sortBy=submittedDate&sortOrder=descending
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Papers/2026-07-25/post-training-rl-watchlist.md
...
- **研究问题**：Post-training RL / RLHF / GRPO 最新论文扫描。
...
| 查询链接 | [原文](https://export.arxiv.org/api/query?search_query=all:reinforcement+learning+language+models+post+training&sortBy=submittedDate&sortOrder=descending) |
| 代码 | 未发现 |
| PDF | 未验证 |
...
flowchart TB
  subgraph Query[今日查询]
    Q1[Post-training RL / RLHF / GRPO 最新论文扫描]
    Q2[arXiv API]
    Q3[timeout / 429]
  end
...
- 原文：https://export.arxiv.org/api/query?search_query=all:reinforcement+learning+language+models+post+training&sortBy=submittedDate&sortOrder=descending
- 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Papers/2026-07-25/post-training-rl-watchlist.md
