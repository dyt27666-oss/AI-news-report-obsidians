...
- 来源类型：预印本索引 / API 检索
- 发布时间：2026-08-27
- 作者/机构：Yufan Wu, Yinghui He, Zhengyi Hu, Lang Wei
- 摘要压缩：Recent advances in inference-time scaling have significantly improved the reasoning performance of large language models (LLMs). However, these methods typically rely on repeated generation or external verification. To address this limitation, we introduce CritICL, a novel inference-time framework that improves reasoning while maintaining high efficiency. Our key insight is that LLM failure modes exhibit structured p
...
| 作者 | Yufan Wu, Yinghui He, Zhengyi Hu, Lang Wei |
| 发布时间 | 2026-08-27 |
| abs | https://arxiv.org/abs/2608.27455v1 |
