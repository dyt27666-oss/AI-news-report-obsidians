...
- 来源类型：预印本索引 / API 检索
- 发布时间：2026-08-27
- 作者/机构：Liyan Tang, Cyrus Rashtchian, Chun-Sung Ferng, Andrew Tomkins
- 摘要压缩：Agent skills package specialized knowledge and workflows into reusable resources that extend AI agent capabilities. Recent work automatically discovers such skills from agent experience, which enables agents to progressively adapt through interaction. However, the insights that guide skill development typically remain scattered across optimization histories, limiting their systematic reuse across iterations. We intro
...
| 作者 | Liyan Tang, Cyrus Rashtchian, Chun-Sung Ferng, Andrew Tomkins |
| 发布时间 | 2026-08-27 |
| abs | https://arxiv.org/abs/2608.27454v1 |
