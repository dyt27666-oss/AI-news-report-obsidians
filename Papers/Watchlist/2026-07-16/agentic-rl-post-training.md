...
> 日期：2026-07-16
> 类型：论文 / 资料 watchlist
> 来源：https://export.arxiv.org/api/query?search_query=all:reinforcement+learning+language+models

## 一句话结论

今日未确认新增高置信 Agentic RL / post-training 论文；保留来源入口和后续查询策略，避免把弱相关或 API 失败结果误报成必读。
...
- 来源入口：https://export.arxiv.org/api/query?search_query=all:reinforcement+learning+language+models
- 日报：[[Daily/2026-07-16]]
