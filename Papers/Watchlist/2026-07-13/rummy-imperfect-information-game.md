...
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Papers/Watchlist/2026-07-13/rummy-imperfect-information-game.md
> 返回日报：[[Daily/2026-07-13]]

## 一句话结论

未确认新增论文；以 GitHub 上 ISMCTS、RLCard、rule engine 候选作为今天可行动线索。
...
未确认新增论文；以 GitHub 上 ISMCTS、RLCard、rule engine 候选作为今天可行动线索。 业务上先拆规则环境、仿真与 evaluator，比追逐低置信论文更可落地。 需要注意：本条目来自自动化雷达采集，若标注为 fallback 或间接扫描，则不能当作完整全网排名，只能当作 watched-source 信号。
