...
> PDF：未确认
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Papers/Watchlist/2026-08-02/rummy-imperfect-information-game.md
...
- **研究问题**：Point Rummy / Game AI 方向是否出现高相关新论文。
...
| 标题 | Rummy imperfect-information game 论文源扫描 |
| 作者/机构 | 未确认 |
| 发布时间 | 未确认 |
| arXiv | [query](https://export.arxiv.org/api/query?search_query=all:rummy+imperfect+information+game+AI) |
| OpenReview / 会议页 | 未发现 |
| Semantic Scholar | 未确认 |
| PDF | 未确认 |
| 代码 | 未发现 |
| 方向 | Point Rummy / Game AI |
