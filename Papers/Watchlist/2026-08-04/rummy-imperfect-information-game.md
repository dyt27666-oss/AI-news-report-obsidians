# Rummy imperfect-information game 论文源扫描 - 2026-08-04
...
```mermaid
flowchart TB
  Q[查询: rummy imperfect information game AI] --> S[arXiv / Semantic Scholar]
  S --> F[严格相关性过滤]
...
可为 Point Rummy 的 belief state、ISMCTS、self-play evaluator 提供参考。 今日因为上游源稳定性不足，日报保留来源链接和主题判断，不写未经核验的论文摘要。
