...
论文来源 arXiv，作者/机构：arXiv authors；今日作为低到中置信论文 watchlist。

## TL;DR

- 核心信号：论文来源 arXiv，作者/机构：arXiv authors；今日作为低到中置信论文 watchlist。
...
flowchart LR
  subgraph Source[来源]
    A[公开信号]
    B[Ideas Have Genomes: Benchmarki]
  end
...
论文来源 arXiv，作者/机构：arXiv authors；今日作为低到中置信论文 watchlist。 对 AI Infra 工程师的意义在于，它可能改变工具链、模型运行时、agent loop 或业务仿真构建方式。
