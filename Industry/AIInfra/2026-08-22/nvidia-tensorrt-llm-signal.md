...
## 一句话结论
TensorRT LLM provides users with an easy-to-use Python API to define Large Language Models (LLMs) and supports state-... 这是 `NVIDIA inference runtime` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：14439 / 2684；语言：Python。
- 最近更新：2026-08-21T23:31:17Z；topics：blackwell, cuda, llm-serving, moe, pytorch。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：12。
...
| forks | 2684 |
| language | Python |
| updated_at | 2026-08-21T23:31:17Z |
| pushed_at | 2026-08-21T23:30:37Z |
...
| AI Infra / Agent 相关性 | TensorRT LLM provides users with an easy-to-use Python API to define Large Language Models (LLMs) and supports state-... | 可转化为 serving、agent loop 或 evaluator 设计线索 |
...
#ai-radar #github #nvidia-inference-runtime
