...
> 一句话结论：今日以 release/changelog 端点扫描 Gemini Code Assist；最新信号为 `v0.60.0`，需要结合原文确认功能细节。

## TL;DR
- 工具/厂商：Gemini Code Assist
- 来源类型：GitHub Release / Changelog / Docs
- 发布时间或 tag：2026-09-15T20:31:02Z / v0.60.0
- 原文：https://github.com/google-gemini/gemini-cli/releases/tag/v0.60.0
...
## 功能变化摘要
## What's Changed * fix(core): improve destination validation and connection routing in web fetch utilities by @diegogodinezr in https://github.com/google-gemini/gemini-cli/pull/29120 * fix(core): enforce RFC 9207 issuer identification in MCP OAuth flow by @jvargassanchez-dot in 
