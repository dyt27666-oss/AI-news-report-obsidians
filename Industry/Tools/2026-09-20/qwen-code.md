...
> 一句话结论：今日以 release/changelog 端点扫描 Qwen Code；最新信号为 `sdk-typescript-v0.1.13`，需要结合原文确认功能细节。

## TL;DR
- 工具/厂商：Qwen Code
- 来源类型：GitHub Release / Changelog / Docs
- 发布时间或 tag：2026-09-19T09:05:56Z / sdk-typescript-v0.1.13
- 原文：https://github.com/QwenLM/qwen-code/releases/tag/sdk-typescript-v0.1.13
...
|---|---|
| 工具 | Qwen Code |
| release/tag | sdk-typescript-v0.1.13 |
| 发布时间 | 2026-09-19T09:05:56Z |
...
## 功能变化摘要
## Bundled CLI Version  This SDK release bundles CLI version: 0.24.1  Source: CLI built from source (same branch/ref as SDK)  ---  ## Bundled CLI Version  This SDK release bundles CLI version: 0.23.3  Source: CLI built from source (same branch/ref as SDK)  ---  ## Bundled CLI Ver
