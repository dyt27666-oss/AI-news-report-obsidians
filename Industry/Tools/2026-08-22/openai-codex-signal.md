...
## 一句话结论
Lightweight coding agent that runs in your terminal 这是 `OpenAI coding agent` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：111309 / 17077；语言：Rust。
- 最近更新：2026-08-22T01:06:11Z；topics：无。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：3951。
...
| forks | 17077 |
| language | Rust |
| updated_at | 2026-08-22T01:06:11Z |
| pushed_at | 2026-08-22T00:44:40Z |
| topics | 无 |
...
| AI Infra / Agent 相关性 | Lightweight coding agent that runs in your terminal | 可转化为 serving、agent loop 或 evaluator 设计线索 |
...
#ai-radar #github #openai-coding-agent
