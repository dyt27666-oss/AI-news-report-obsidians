...
## 一句话结论
已获取 latest release；代表更新：v2.0.0-vscode / v2.0.0-vscode / 2026-06-19T00:24:01Z。

## 信息压缩图示
```mermaid
flowchart TB
  T[Continue] --> S[来源类型: GitHub Releases]
  S --> F[功能变化检查]
...
| 代表更新 | v2.0.0-vscode / v2.0.0-vscode / 2026-06-19T00:24:01Z |
