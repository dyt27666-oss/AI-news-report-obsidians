...
> 一句话结论：Continue 今日 release/changelog 扫描结果：v2.0.0-vscode / v2.0.0-vscode / 2026-06-19。关注 agent mode、MCP、IDE 集成、CLI/TUI、权限模式、上下文窗
...
Continue 今日 release/changelog 扫描结果：v2.0.0-vscode / v2.0.0-vscode / 2026-06-19。关注 agent mode、MCP、IDE 集成、CLI/TUI、权限模式、上下文窗口、pricing/rate limit 对 AI coding 工作流的影响。
