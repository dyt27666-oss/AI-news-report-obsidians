...
> 一句话结论：Qwen Code 今日 release/changelog 扫描结果：Release v0.23.0 / v0.23.0 / 2026-09-03。关注 agent mode、MCP、IDE 集成、CLI/TUI、权限模式、上下文窗口、p
...
| 原文 | [link](https://github.com/QwenLM/qwen-code/releases/tag/v0.23.0) |
...
Qwen Code 今日 release/changelog 扫描结果：Release v0.23.0 / v0.23.0 / 2026-09-03。关注 agent mode、MCP、IDE 集成、CLI/TUI、权限模式、上下文窗口、pricing/rate limit 对 AI coding 工作流的影响。
