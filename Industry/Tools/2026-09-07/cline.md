...
> 一句话结论：Cline 今日 release/changelog 扫描结果：Desktop v0.0.23 / desktop-v0.0.23 / 2026-09-03。关注 agent mode、MCP、IDE 集成、CLI/TUI、权限模式、上下文
...
| 原文 | [link](https://github.com/cline/cline/releases/tag/desktop-v0.0.23) |
...
Cline 今日 release/changelog 扫描结果：Desktop v0.0.23 / desktop-v0.0.23 / 2026-09-03。关注 agent mode、MCP、IDE 集成、CLI/TUI、权限模式、上下文窗口、pricing/rate limit 对 AI coding 工作流的影响。
