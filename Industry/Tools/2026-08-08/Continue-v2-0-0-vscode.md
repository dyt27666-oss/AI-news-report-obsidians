# Continue-v2-0-0-vscode

> 日期：2026-08-08  
> 来源：Continue / Continue  
> 原文：https://github.com/continuedev/continue/releases/tag/v2.0.0-vscode

## 一句话结论
Continue release 源显示最新 tag v2.0.0-vscode，发布时间 2026-06-19。
...
| 字段 | 内容 |
|---|---|
| 标题 | Continue-v2-0-0-vscode |
| 来源 | Continue / Continue |
| 来源类型 | GitHub Releases |
| 日期 | 2026-08-08 |
| 原文 | [link](https://github.com/continuedev/continue/releases/tag/v2.0.0-vscode) |

## 信息压缩图示
```mermaid
flowchart TB
  subgraph S[来源信号]
    A[Continue-v2-0-0-vscode]
    B[Continue / Continue]
    C[原文/API 可追溯]
  end
  subgraph M[机制拆解]
...
## 可信度与局限性
- 可信来源：https://github.com/continuedev/continue/releases/tag/v2.0.0-vscode
