...
## 一句话结论
anthropics/claude-code 是今日 Loop Engineer 固定观察集里的高信号项目；在 GitHub Search rate limit 下，使用 direct `/repos` 元数据保持续报。

## TL;DR
- stars：147656；forks：24135；language：TypeScript。
- updated_at：2026-09-23T00:57:36Z。
- topics：未标注。
- 增长依据：direct watched repo fallback，非完整全网日增；baseline=github-stars-2026-09-22.json；stars_delta=185。
...
| 描述 | Claude Code is an agentic coding tool that lives in your terminal, understands your codebase, and helps you code faster by executing routine tasks, explaining complex code, and ha… |
...
| 维度 | 观察点 | 今日判断 |
|---|---|---|
| 活跃度 | updated_at / pushed_at | 2026-09-23T00:57:36Z / 2026-09-22T16:38:13Z |
| 生态位置 | topics / language | TypeScript |
