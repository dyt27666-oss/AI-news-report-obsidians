...
> 一句话结论：今日以 release/changelog 端点扫描 Gemini Code Assist；最新信号为 `v0.59.0`，需要结合原文确认功能细节。

## TL;DR
- 工具/厂商：Gemini Code Assist
- 来源类型：GitHub Release / Changelog / Docs
- 发布时间或 tag：2026-09-08T21:13:43Z / v0.59.0
...
## 功能变化摘要
## What's Changed * Changelog for v0.58.0-preview.0 by @gemini-cli-robot in https://github.com/google-gemini/gemini-cli/pull/29082 * chore(release): bump version to 0.59.0-nightly.20260825.g812f7a2bc by @gemini-cli-robot
