...
> 一句话结论：今日以 release/changelog 端点扫描 OpenAI Codex；最新信号为 `rust-v0.154.0`，需要结合原文确认功能细节。

## TL;DR
- 工具/厂商：OpenAI Codex
- 来源类型：GitHub Release / Changelog / Docs
- 发布时间或 tag：2026-09-09T22:35:38Z / rust-v0.154.0
...
## 功能变化摘要
## New Features  - GPT-6-Astra is now available in the model picker and Amazon Bedrock catalogs. (#42879, #42619) - Experimental worktree support lets you create isolated checkouts for new or forked sessions using `--wor
