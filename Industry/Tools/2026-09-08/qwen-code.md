# Qwen Code 工具更新扫描 - 2026-09-08

> 一句话结论：Qwen Code 今日进入 Coding 工具固定矩阵；重点观察 agent mode、MCP、IDE/CLI、权限与上下文窗口变化。
...
## 对我的影响
开源 terminal coding agent 对本地 loop engineering 有参考价值。如果 release 内容确认包含权限模式、MCP、远程执行、agent loop 或上下文窗口变化，应升级为必读并做实测。
