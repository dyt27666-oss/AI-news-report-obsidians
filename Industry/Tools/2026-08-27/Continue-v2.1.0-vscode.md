...
> 一句话结论：Continue 今日被纳入 Coding 工具矩阵；本次记录聚焦 agent mode、MCP、IDE/CLI、权限和上下文窗口等对 AI coding workflow 的影响。

## TL;DR

- 工具/厂商：Continue
- 来源类型：GitHub Release
- 发布时间 / release tag：2026-06-19
- 原文链接：https://github.com/continuedev/continue/releases/tag/v2.1.0-vscode
- 功能变化：未发现明确高相关新功能，保留扫描状态
...
| 工具 | Continue |
| 来源类型 | GitHub Release |
| 标题/Tag | v2.1.0-vscode |
| 发布时间 | 2026-06-19 |
| 原文 | https://github.com/continuedev/continue/releases/tag/v2.1.0-vscode |
...
| 变化类型 | 今日观察 | 影响 |
|---|---|---|
| Agent 能力 | 未稳定解析到新项 | 影响能否把复杂任务交给 coding agent 自主闭环 |
