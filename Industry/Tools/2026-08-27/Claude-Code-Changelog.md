# Claude Code - Changelog 扫描记录

> 一句话结论：Claude Code 今日被纳入 Coding 工具矩阵；本次记录聚焦 agent mode、MCP、IDE/CLI、权限和上下文窗口等对 AI coding workflow 的影响。

## TL;DR

- 工具/厂商：Claude Code
- 来源类型：Changelog
- 发布时间 / release tag：2026-08-27
- 原文链接：https://docs.anthropic.com/en/release-notes/claude-code
- 功能变化：今日访问 release-notes 页面，未稳定解析到明确高相关新功能；继续关注 Claude Tag、权限模式、MCP 和 CLI/TUI 变化。
...
| 变化类型 | 今日观察 | 影响 |
|---|---|---|
| Agent 能力 | 今日访问 release-notes 页面，未稳定解析到明确高相关新功能；继续关注 Claude Tag、权限模式、MCP 和 CLI/TUI 变化。 | 影响能否把复杂任务交给 coding agent 自主闭环 |
