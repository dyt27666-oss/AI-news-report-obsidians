...
> 一句话结论：今日以 release/changelog 端点扫描 GitHub Copilot；最新信号为 `docs/changelog`，需要结合原文确认功能细节。

## TL;DR
- 工具/厂商：GitHub Copilot
- 来源类型：GitHub Release / Changelog / Docs
- 发布时间或 tag：网页扫描低置信 / docs/changelog
