# Codex 0.145.0: paginated thread history、resume/search、sub-agent、memories、settings import
...
> 推荐等级：必读
> 创建日期：2026-07-25
> 原文链接：https://github.com/openai/codex/releases/tag/rust-v0.145.0
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Industry/Tools/2026-07-25/openai-codex-0-145-0.md
> 返回日报：[[Daily/2026-07-25]]

## 一句话结论

Codex 0.145.0: paginated thread history、resume/search、sub-agent、memories、settings import，说明 coding agent 正在向更长上下文、更强会话恢复、更细权限边界和多 agent 协作演进。

## TL;DR

- **它是什么**：GitHub Release / Changelog 中记录的 AI coding 工具功能更新。
...
| 原文 | [原文](https://github.com/openai/codex/releases/tag/rust-v0.145.0) |
