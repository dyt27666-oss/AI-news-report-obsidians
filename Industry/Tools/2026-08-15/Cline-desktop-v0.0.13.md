...
> 发布时间 / release tag：2026-08-14 / `desktop-v0.0.13`
> 原文：https://github.com/cline/cline/releases/tag/desktop-v0.0.13

## 一句话结论
Cline 今天作为 AI coding workflow 固定扫描对象记录；重点观察 agent mode、MCP、权限、CLI/TUI、IDE 集成和远程执行相关变化。

## TL;DR
- 代表更新：Desktop v0.0.13
- release tag：desktop-v0.0.13
- 发布时间：2026-08-14
- 摘要：- Added an app font size setting. A slider in Settings scales the interface, and your size is applied before the window paints, so launching no longer flashes at the old size first. - Models that support it can now search the web during a t…
