...
> 一句话结论：Qwen Code 今日通过 release/direct watch 进入 Coding 工具扫描矩阵；需要关注 agent mode、MCP、权限、远程执行、上下文和 CLI/TUI 体验。

## TL;DR

- 工具/厂商：Qwen Code
- 来源类型：GitHub Release / Release Notes
- Release tag：v0.21.11
- 发布时间：2026-08-13
- 原文：https://github.com/QwenLM/qwen-code/releases/tag/v0.21.11
...
- Enabled native multi-agent workflows with read-only teammates via the /coordinate comma
