# Cline 工具更新扫描 - 2026-07-31

> 工具/厂商：Cline / Cline  
> 来源类型：GitHub Release / Docs  
> 发布时间或 release tag：desktop-v0.0.7 / 2026-07-29  
> 原文：https://github.com/cline/cline/releases/tag/desktop-v0.0.7

## 一句话结论
Cline 今日进入 coding tool 矩阵；重点不是夸大功能，而是持续跟踪 agent mode、MCP、权限、CLI/TUI、IDE 集成和 rate limit 对工作流的影响。

## TL;DR
- 今日代表更新：desktop-v0.0.7 / 2026-07-29
