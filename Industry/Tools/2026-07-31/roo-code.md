# Roo Code 工具更新扫描 - 2026-07-31

> 工具/厂商：Roo Code / Roo Code  
> 来源类型：GitHub Release / Docs  
> 发布时间或 release tag：v3.54.0 / 2026-05-15  
> 原文：https://github.com/RooCodeInc/Roo-Code/releases/tag/v3.54.0

## 一句话结论
Roo Code 今日进入 coding tool 矩阵；重点不是夸大功能，而是持续跟踪 agent mode、MCP、权限、CLI/TUI、IDE 集成和 rate limit 对工作流的影响。

## TL;DR
- 今日代表更新：v3.54.0 / 2026-05-15
