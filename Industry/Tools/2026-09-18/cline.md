...
> 一句话结论：今日以 release/changelog 端点扫描 Cline；最新信号为 `desktop-v0.0.31`，需要结合原文确认功能细节。

## TL;DR
- 工具/厂商：Cline
- 来源类型：GitHub Release / Changelog / Docs
- 发布时间或 tag：2026-09-17T21:41:12Z / desktop-v0.0.31
- 原文：https://github.com/cline/cline/releases/tag/desktop-v0.0.31
...
|---|---|
| 工具 | Cline |
| release/tag | desktop-v0.0.31 |
| 发布时间 | 2026-09-17T21:41:12Z |
...
## 功能变化摘要
 - Cline can now work on a remote machine over SSH, with the app itself staying local. Add and test a host under **Settings → Remote**, then pick it from the environment selector beside the workspace picker on the welcom
