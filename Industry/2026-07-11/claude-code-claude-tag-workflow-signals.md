# Claude Code / Claude Tag workflow signals
...
Claude Code / Claude Tag workflow signals 保留为 AI Infra / agent workflow 观察信号。

## TL;DR

- 核心信号：Claude Code / Claude Tag workflow signals 保留为 AI Infra / agent workflow 观察信号。
...
flowchart LR
  subgraph Source[来源]
    A[公开信号]
    B[Claude Code / Claude Tag workf]
  end
...
Claude Code / Claude Tag workflow signals 保留为 AI Infra / agent workflow 观察信号。 对 AI Infra 工程师的意义在于，它可能改变工具链、模型运行时、agent loop 或业务仿真构建方式。
