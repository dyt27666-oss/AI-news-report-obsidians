...
> Web: https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Industry/2026-06-15/Anthropic-Agents-in-Biology.md
> Daily: [[Daily/2026-06-15]]

## One-line takeaway

Domain agents and scientific task evaluation; interpret it as a signal for AI infra, LLM engineering, agent eval, or serving cost control.

## TL;DR

- What it is: a company source item from Anthropic.
...
| Source | [original](https://www.anthropic.com/research/agents-in-biology) |
| Code | Not found |
| PDF | Not found |
...
flowchart LR
  subgraph Source[Publisher]
    C[Anthropic]
    A[Domain agents and scientific task evaluation]
  end
