...
## 一句话结论
今日未确认 Anthropic 有 AI Infra / LLM / RL / Agent / Eval 强相关的新发布；保留为固定矩阵扫描位，避免漏扫。

## TL;DR
- **它是什么**：Anthropic 的固定公司来源扫描记录。
...
flowchart LR
  ...
  class C,B company; class S1,S2,S3 signal; class I1,I2,I3 impact;
```
