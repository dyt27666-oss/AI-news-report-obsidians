...
- 建议今天深读：Qwen Code nightly、Cline 4.0.5、Hugging Face ScarfBench、Point Rummy watchlist、Hermes/Firecrawl runtime 对照页。
...
| 可 skim | Industry | Hugging Face / Eval | ScarfBench | 企业 Java 框架迁移 agent benchmark。 | 真实工程迁移任务比 toy benchmark 更适合评估 coding agent。 | [[Industry/2026-07-01/huggingface-scarfbench-agent-migration]] | [网页详情](https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/Industry/2026-07-01/huggingface-scarfbench-agent-migration.md) | [原文](https://huggingface.co/blog) |
