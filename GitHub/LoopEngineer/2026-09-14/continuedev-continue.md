...
## 一句话结论
continuedev/continue 今日作为 LoopEngineer watched repo fallback 进入 Radar；增长数据需按“非完整全网日增”理解。

## TL;DR
- Stars：35895；Forks：5375；Language：TypeScript。
- 最近更新：2026-09-13T19:02:51Z；增长依据：cross-snapshot direct watched repo fallback，非完整全网日增。
...
| stars / forks | 35895 / 5375 |
| language | TypeScript |
| topics | agent, ai, cli, developer-tools, open-source |
| updated_at | 2026-09-13T19:02:51Z |
...
## 专业解读
continuedev/continue 的价值不只是 star 数，而是它代表的生态位置：runtime、agent loop、模型框架或业务 baseline。今天的 direct fallback 能保证固定主题不断档，但不能替代完整 GitHub Search。
