...
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/LoopEngineer/2026-07-17/continuedev__continue.md
> 返回日报：[[Daily/2026-07-17]]

## 一句话结论

开源 coding agent；适合观察 IDE/CLI 结合、模型路由和企业内自托管。

## TL;DR

- **它是什么**：continuedev/continue 的今日雷达条目。
...
开源 coding agent；适合观察 IDE/CLI 结合、模型路由和企业内自托管。 该 repo 对今日 AI Infra / coding agent / RL radar 有可行动观察价值。 若标注为 fallback 或间接扫描，则不能当作完整全网排名，只能当作 watched-source 信号。
