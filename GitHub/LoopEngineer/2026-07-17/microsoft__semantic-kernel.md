...
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/LoopEngineer/2026-07-17/microsoft__semantic-kernel.md
> 返回日报：[[Daily/2026-07-17]]

## 一句话结论

企业 LLM app/agent SDK；适合插件化 agent 编排和 workflow 集成。

## TL;DR

- **它是什么**：microsoft/semantic-kernel 的今日雷达条目。
...
| 字段 | 内容 |
|---|---|
| 发布方/来源 | microsoft/semantic-kernel |
| 栏目/来源类型 | GitHub repo / watched fallback |
| 作者/机构 | microsoft/semantic-kernel |
| 发布时间 | 2026-07-17 |
| 原文 | [原文](https://github.com/microsoft/semantic-kernel) |
| 代码 | https://github.com/microsoft/semantic-kernel |
| PDF | 未发现 |
| 标签 | #ai-radar |
...
企业 LLM app/agent SDK；适合插件化 agent 编排和 workflow 集成。 该 repo 对今日 AI Infra / coding agent / RL radar 有可行动观察价值。 若标注为 fallback 或间接扫描，则不能当作完整全网排名，只能当作 watched-source 信号。
