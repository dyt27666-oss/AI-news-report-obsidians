...
> 原文：https://github.com/All-Hands-AI/OpenHands

## 一句话结论

AI 软件工程 agent 平台，对任务执行 loop、浏览器/终端工具和 sandbox 有参考。

## TL;DR

- 核心信号：AI 软件工程 agent 平台，对任务执行 loop、浏览器/终端工具和 sandbox 有参考。
...
AI 软件工程 agent 平台，对任务执行 loop、浏览器/终端工具和 sandbox 有参考。 对 AI Infra 工程师的意义在于，它可能改变工具链、模型运行时、agent loop 或业务仿真构建方式。
