...
SDK/IDE/CLI 一体化 coding agent，是开源 agent workflow 的重要对照。

## TL;DR

- 核心信号：SDK/IDE/CLI 一体化 coding agent，是开源 agent workflow 的重要对照。
...
SDK/IDE/CLI 一体化 coding agent，是开源 agent workflow 的重要对照。 对 AI Infra 工程师的意义在于，它可能改变工具链、模型运行时、agent loop 或业务仿真构建方式。
