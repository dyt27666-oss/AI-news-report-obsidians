# QwenLM/qwen-code - 2026-07-10

## 一句话结论
Qwen Code 作为国产开源 terminal coding agent，可纳入多模型、多供应商 coding workflow 对比。

## TL;DR
- repo：[QwenLM/qwen-code](https://github.com/QwenLM/qwen-code)
- stars / forks：25903 / 2627
- language：TypeScript
- updated_at：2026-07-10T00:01:09Z
...
| topics | coding-agent, terminal, qwen |
...
## 专业解读
QwenLM/qwen-code 今天通过 direct GitHub API 进入榜单。由于 GitHub Search 已 403，本页不把它解释成“全网增长最快”，而是把它作为固定 watched repo 观察点。对 AI Infra 工程来说，重点不是单日 star，而是它在 serving、training runtime、agent loop 或工具协议中的位置。
