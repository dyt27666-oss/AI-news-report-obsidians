# continuedev/continue - 2026-07-10

## 一句话结论
Continue 是开源自托管 coding agent/IDE workflow，对企业内网与本地模型接入有参考。

## TL;DR
- repo：[continuedev/continue](https://github.com/continuedev/continue)
- stars / forks：34769 / 5003
- language：TypeScript
- updated_at：2026-07-10T00:41:53Z
...
| topics | agent, ai, cli, developer-tools |
...
## 专业解读
continuedev/continue 今天通过 direct GitHub API 进入榜单。由于 GitHub Search 已 403，本页不把它解释成“全网增长最快”，而是把它作为固定 watched repo 观察点。对 AI Infra 工程来说，重点不是单日 star，而是它在 serving、training runtime、agent loop 或工具协议中的位置。
