# cline/cline - 2026-07-10

## 一句话结论
Cline 最新 cli-v3.0.39 继续推进 SDK/IDE/CLI 一体化，是开源 coding agent 对照组。

## TL;DR
- repo：[cline/cline](https://github.com/cline/cline)
- stars / forks：64498 / 6880
- language：TypeScript
- updated_at：2026-07-10T00:52:11Z
...
| repo | cline/cline |
| topics | coding-agent, sdk, ide, cli |
...
## 专业解读
cline/cline 今天通过 direct GitHub API 进入榜单。由于 GitHub Search 已 403，本页不把它解释成“全网增长最快”，而是把它作为固定 watched repo 观察点。对 AI Infra 工程来说，重点不是单日 star，而是它在 serving、training runtime、agent loop 或工具协议中的位置。
