...
> 一句话结论：modelcontextprotocol/servers 是今日 AI Radar 观察集合中的高信号项目；当前采用 direct watched-repo fallback，增长不代表全 GitHub 排名。

## TL;DR
- Stars：89937；Forks：11520；语言：TypeScript。
...
| stars / forks | 89937 / 11520 |
| stars_delta | 45（direct watched repo fallback vs 2026-08-28 snapshot，非完整全网日增） |
| language | TypeScript |
| updated_at | 2026-08-29T01:05:20Z |
| topics | 未标注 |
...
flowchart TB
  ...
  subgraph Repo[项目: modelcontextprotocol/servers]
    R1[代码/文档]
    R2[社区 stars: 89937]
    R3[更新: 2026-08-29]
    R4[主题: 未标注]
...
## 专业解读
Model Context Protocol Servers。对于 AI Infra 工程，应重点看它是否能减少推理/训练/agent orchestration 中的状态管理、调度或集成成本。
