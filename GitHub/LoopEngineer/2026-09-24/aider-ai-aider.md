...
## 一句话结论
Aider-AI/aider 今日作为 `Coding Agent Loop / MCP / Context Engineering` 固定观察项进入 AI Radar；由于 GitHub Search 403，本页来自 direct watched repo fallback，增长不代表完整全网日增。

## TL;DR
- stars / forks：49137 / 4985
- language：Python
- updated_at：2026-09-23T22:31:47Z
...
flowchart TB
  ...
  subgraph System[Aider-AI/aider]
    S1[核心能力]
    S2[Runtime / API]
    S3[状态 / 上下文 / 缓存]
