...
## 一句话结论
firecrawl/firecrawl 是今日 AI Radar 的 fallback 观察项；对 AI Infra / agent loop / RL 工程的价值主要在于：The context API to search, scrape, and interact with the web at scale. 🔥。

## TL;DR
- Stars / Forks：177665 / 9695
- 语言：TypeScript
- 更新时间：2026-09-08T01:04:43Z
- Topics：ai, ai-agents, ai-crawler, ai-scraping, ai-search, crawler, data-extraction, html-to-markdown, llm, markdown, scraper, scraping, web-crawler, web-data, web-data-extraction, web-scraper, web-scraping, web-search, webscraping
- 增长：1503；依据：current/direct metadata vs github-stars-2026-09-04.json，非完整全网日增
...
| pushed_at | 2026-09-08T00:35:56Z |
| topics | ai, ai-agents, ai-crawler, ai-scraping, ai-search, crawler, data-extraction, html-to-markdown, llm, markdown, scraper, scraping, web-crawler, web-data, web-data-extraction, web-scraper, web-scraping, web-search, webscraping |
