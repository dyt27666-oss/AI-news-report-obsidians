...
> 日期：2026-09-10  
> 类型：GitHub 项目详情  
> 原文：[BerriAI/litellm](https://github.com/BerriAI/litellm)

## 一句话结论
BerriAI/litellm 是今日 AI Radar 的 fallback 观察项；对 AI Infra / agent loop / RL 工程的价值主要在于：The fastest, litest AI Gateway. Rust core with Python SDK. Call 100+ LLM APIs in OpenAI (or native) format with cost tracking, guardrails, load balancing, and logging [Bedrock, Az…。

## TL;DR
- Stars / Forks：58233 / 11252
- 语言：Python
- 更新时间：2026-09-08T01:04:40Z
...
- 增长：261；依据：current/direct metadata vs github-stars-2026-09-04.json，非完整全网日增
...
| pushed_at | 2026-09-08T01:07:53Z |
| topics | ai-gateway, anthropic, azure-openai, bedrock, gateway, langchain, litellm, llm, llm-gateway, llmops, mcp-gateway, openai, openai-proxy, rust, rust-ai, vertex-ai |
