...
## 一句话结论
langgenius/dify 是今日 AI Radar 的 fallback 观察项；对 AI Infra / agent loop / RL 工程的价值主要在于：Build Agentic workflows, RAG pipelines, with rich AI model and tool support on one collaborative workspace. Deploy on cloud, VPC, or self-hosted, so teams move from prototype to p…。

## TL;DR
- Stars / Forks：154860 / 24467
- 语言：TypeScript
- 更新时间：2026-09-08T01:04:02Z
...
- 增长：488；依据：current/direct metadata vs github-stars-2026-09-04.json，非完整全网日增
...
| pushed_at | 2026-09-07T16:30:07Z |
| topics | agent, agentic-ai, agentic-framework, agentic-workflow, ai, automation, claude, deepseek, genai, gpt, llm, low-code, mcp, nextjs, no-code, openai, python, skills, workflow |
