...
## TL;DR
- stars：29311；forks：2960；language：TypeScript。
- updated_at：2026-09-04T01:05:39Z；growth_basis：direct watched repo fallback vs github-stars-2026-09-03.json，非完整全网日增。
...
flowchart TB
  ...
  subgraph System[can1357/oh-my-pi 核心信号]
    S1[Repo metadata]
    S2[README/Topics]
...
## 专业解读
IDE wired coding agent，强调 terminal/TUI、多 provider、MCP 和编辑器闭环。 今日由于 GitHub Search 403，本页使用 direct `/repos` 元数据维持知识库连续性；它不是全网增长榜，但适合作为固定 watchlist 的真实元数据快照。
