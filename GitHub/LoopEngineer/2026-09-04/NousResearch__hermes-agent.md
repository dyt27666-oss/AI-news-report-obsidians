...
## TL;DR
- stars：240846；forks：49350；language：Python。
- updated_at：2026-09-04T01:03:02Z；growth_basis：direct watched repo fallback vs github-stars-2026-09-03.json，非完整全网日增。
...
| language | Python |
| topics | ai, ai-agent, ai-agents, anthropic, chatgpt, claude, claude-code, codex, hermes, hermes-agent |
...
flowchart TB
  ...
  subgraph System[NousResearch/hermes-agent 核心信号]
    S1[Repo metadata]
    S2[README/Topics]
...
## 专业解读
Hermes Agent 本体，覆盖 scheduled jobs、skills、tools、gateway，是本日报系统和自动化 agent 工作流的基础设施。 今日由于 GitHub Search 403，本页使用 direct `/repos` 元数据维持知识库连续性；它不是全网增长榜，但适合作为固定 watchlist 的真实元数据快照。
