...
## TL;DR
- stars：106805；forks：14526；language：TypeScript。
- updated_at：2026-09-04T00:13:21Z；growth_basis：direct watched repo fallback vs github-stars-2026-09-03.json，非完整全网日增。
...
flowchart TB
  ...
  subgraph System[google-gemini/gemini-cli 核心信号]
    S1[Repo metadata]
    S2[README/Topics]
...
## 专业解读
Gemini 终端 agent，适合观察 MCP client/server、CLI agent 和 Google coding workflow。 今日由于 GitHub Search 403，本页使用 direct `/repos` 元数据维持知识库连续性；它不是全网增长榜，但适合作为固定 watchlist 的真实元数据快照。
