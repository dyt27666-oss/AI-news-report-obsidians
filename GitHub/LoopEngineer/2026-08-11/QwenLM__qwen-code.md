# QwenLM/qwen-code - 2026-08-11

> 一句话结论：`QwenLM/qwen-code` 是今日 Loop Engineer watched fallback 里的高信号项目；由于 GitHub Search 403，本页把它作为可验证 direct `/repos` 信号，而非完整全网排名。

## TL;DR
- Repo：[QwenLM/qwen-code](https://github.com/QwenLM/qwen-code)
- Stars / Forks：26900 / 2836
- 语言：TypeScript
- 更新时间：2026-08-11T00:59:18Z
- 今日增长：16（direct watched repo fallback vs github-stars-2026-08-10.json; 非完整全网日增）
- 主题：agentic, ai, ai-agent, ai-coding, cli, coding-agent, developer-tools, llm, mcp, qwen, terminal, typescript
