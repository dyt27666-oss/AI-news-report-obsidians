# microsoft/semantic-kernel - 2026-08-11

> 一句话结论：`microsoft/semantic-kernel` 是今日 Loop Engineer watched fallback 里的高信号项目；由于 GitHub Search 403，本页把它作为可验证 direct `/repos` 信号，而非完整全网排名。

## TL;DR
- Repo：[microsoft/semantic-kernel](https://github.com/microsoft/semantic-kernel)
- Stars / Forks：28439 / 4713
- 语言：C#
- 更新时间：2026-08-10T17:46:43Z
- 今日增长：6（direct watched repo fallback vs github-stars-2026-08-10.json; 非完整全网日增）
- 主题：ai, artificial-intelligence, llm, openai, sdk
...
flowchart TB
  ...
  subgraph System[microsoft/semantic-kernel]
    S1[核心代码]
    S2[文档/示例]
    S3[Release/Issue 信号]
    S4[社区 stars/forks]
