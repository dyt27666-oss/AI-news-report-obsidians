# sgl-project/sglang - 2026-08-11

> 一句话结论：`sgl-project/sglang` 是今日 Loop Engineer watched fallback 里的高信号项目；由于 GitHub Search 403，本页把它作为可验证 direct `/repos` 信号，而非完整全网排名。

## TL;DR
- Repo：[sgl-project/sglang](https://github.com/sgl-project/sglang)
- Stars / Forks：31640 / 7787
- 语言：Python
- 更新时间：2026-08-11T01:02:55Z
- 今日增长：52（direct watched repo fallback vs github-stars-2026-08-10.json; 非完整全网日增）
- 主题：attention, blackwell, cuda, deepseek, diffusion, glm, gpt-oss, inference, llama, llm, minimax, moe, qwen, qwen-image, reinforcement-learning, transformer, vlm, wan
...
flowchart TB
  ...
  subgraph System[sgl-project/sglang]
    S1[核心代码]
    S2[文档/示例]
    S3[Release/Issue 信号]
    S4[社区 stars/forks]
