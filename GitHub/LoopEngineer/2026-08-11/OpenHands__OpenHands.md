# OpenHands/OpenHands - 2026-08-11

> 一句话结论：`OpenHands/OpenHands` 是今日 Loop Engineer watched fallback 里的高信号项目；由于 GitHub Search 403，本页把它作为可验证 direct `/repos` 信号，而非完整全网排名。

## TL;DR
- Repo：[OpenHands/OpenHands](https://github.com/OpenHands/OpenHands)
- Stars / Forks：83642 / 10823
- 语言：TypeScript
- 更新时间：2026-08-11T01:06:22Z
- 今日增长：87（direct watched repo fallback vs github-stars-2026-08-10.json; 非完整全网日增）
- 主题：agent, artificial-intelligence, chatgpt, claude-ai, cli, developer-tools, gpt, llm, openai
