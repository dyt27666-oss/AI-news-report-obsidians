# vercel/ai - 2026-08-11

> 一句话结论：`vercel/ai` 是今日 Loop Engineer watched fallback 里的高信号项目；由于 GitHub Search 403，本页把它作为可验证 direct `/repos` 信号，而非完整全网排名。

## TL;DR
- Repo：[vercel/ai](https://github.com/vercel/ai)
- Stars / Forks：26119 / 4936
- 语言：TypeScript
- 更新时间：2026-08-11T00:54:41Z
- 今日增长：None（direct watched repo fallback vs github-stars-2026-08-10.json; 非完整全网日增）
- 主题：anthropic, artificial-intelligence, gemini, generative-ai, generative-ui, javascript, language-model, llm, nextjs, openai, react, svelte, typescript, vercel, vue
...
| 原文链接 | https://github.com/vercel/ai |
