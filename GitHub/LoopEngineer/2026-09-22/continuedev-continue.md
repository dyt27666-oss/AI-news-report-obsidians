...
## 一句话结论
continuedev/continue 是今日 AI Radar 关注的项目；本页基于 GitHub 元数据与历史 snapshot，用于判断是否值得试用或跟踪。

## TL;DR
- stars / forks：35978 / 5409
- language：TypeScript
- updated_at：2026-09-21T23:07:52Z
- topics：agent, ai, cli, developer-tools, open-source
- 描述：open-source coding agent
- 今日增长依据：direct watched repo fallback，非完整全网日增；stars_delta=15
...
flowchart TB
  ...
  subgraph Repo[GitHub 项目]
    R1[continuedev/continue]
    R2[语言: TypeScript]
    R3[stars: 35978]
    R4[topics: agent, ai, cli, developer-tools, open-source]
  end
...
## 相关链接
- 原文：https://github.com/continuedev/continue
- GitHub 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/LoopEngineer/2026-09-22/continuedev-continue.md
