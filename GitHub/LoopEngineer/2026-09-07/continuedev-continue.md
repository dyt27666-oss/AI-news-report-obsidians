...
> 一句话结论：`continuedev/continue` 今日进入 AI Radar。描述：open-source coding agent。stars=35808，forks=5343，language=TypeScript，updated_at=2
...
| 日期 | 2026-09-07 |
| 类型 | GitHub |
| 原文 | [link](https://github.com/continuedev/continue) |
...
`continuedev/continue` 今日进入 AI Radar。描述：open-source coding agent。stars=35808，forks=5343，language=TypeScript，updated_at=2026-09-07T00:38:06Z。增长依据：direct/current snapshot vs github-stars-2026-09-04.json，非完整全网日增。对用户而言，重点看它是否能复用到 LLM serving/training、agent loop、coding workflow 或 Point Rummy 业务建模。
