...
> 一句话结论：`BerriAI/litellm` 今日进入 AI Radar。描述：The fastest, litest AI Gateway. Rust core with Python SDK. Call 100+ LLM APIs in Open
...
| 日期 | 2026-09-07 |
| 类型 | GitHub |
| 原文 | [link](https://github.com/BerriAI/litellm) |
...
`BerriAI/litellm` 今日进入 AI Radar。描述：The fastest, litest AI Gateway. Rust core with Python SDK. Call 100+ LLM APIs in OpenAI (or native) format with cost tracking, guardrails, load balancing, and logging [Bedrock, Azure, OpenAI, Anthropic, OpenAI, VertexAI, vLLM, Nvidia NIM]。stars=58169，forks=11218，language=Python，updated_at=2026-09-06T22:36:50Z。增长依据：direct/current snapshot vs github-stars-2026-09-04.json，非完整全网日增。对用户而言，重点看它是否能复用到 LLM serving/training、agent loop、coding workflow 或 Point Rummy 业务建模。
