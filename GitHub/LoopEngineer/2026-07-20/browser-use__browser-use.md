...
| stars / forks | 105574 / 11623 |
| language | Python |
| updated_at | 2026-07-20T00:44:49Z |
...
## 专业解读
浏览器自动化 agent，适合 Web 工具调用、端到端 eval 和权限观测。 对用户而言，核心判断是它能否转化为可执行工程动作：降低推理成本、改善 agent loop 可观测性、形成可复用 benchmark，或给 Point Rummy / RL 环境提供规则和评测抽象。
