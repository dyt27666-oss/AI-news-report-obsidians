...
## 一句话结论
IDE/CLI 自主 coding agent，适合观察 extension 内 agent SDK、工具调用和权限 UX。
...
| stars / forks | 64815 / 6941 |
| language | TypeScript |
| updated_at | 2026-07-20T00:42:00Z |
...
## 专业解读
IDE/CLI 自主 coding agent，适合观察 extension 内 agent SDK、工具调用和权限 UX。 对用户而言，核心判断是它能否转化为可执行工程动作：降低推理成本、改善 agent loop 可观测性、形成可复用 benchmark，或给 Point Rummy / RL 环境提供规则和评测抽象。
