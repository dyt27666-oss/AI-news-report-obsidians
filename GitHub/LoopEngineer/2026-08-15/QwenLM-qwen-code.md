...
## 一句话结论
QwenLM/qwen-code 是今日 AI Radar watched-repo 信号之一；在 GitHub Search 受限时用于维持 AI Infra / Loop Engineering / Point Rummy 的连续观察基线。

## TL;DR
- Stars：27007；Forks：2859；语言：TypeScript。
- 更新：2026-08-15T00:28:40Z；topics：agentic, ai, ai-agent, ai-coding, cli, coding-agent, developer-tools, llm, mcp, qwen, terminal, typescript。
- 摘要：An open-source AI coding agent that lives in your terminal.
- 增长：25；依据：direct watched repo fallback vs most recent snapshot，非完整全网日增。
...
| stars / forks | 27007 / 2859 |
| language | TypeScript |
| updated_at | 2026-08-15T00:28:40Z |
| 原文 | https://github.com/QwenLM/qwen-code |
