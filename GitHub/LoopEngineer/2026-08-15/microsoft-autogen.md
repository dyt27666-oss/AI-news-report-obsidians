...
## 一句话结论
microsoft/autogen 是今日 AI Radar watched-repo 信号之一；在 GitHub Search 受限时用于维持 AI Infra / Loop Engineering / Point Rummy 的连续观察基线。

## TL;DR
- Stars：60424；Forks：9106；语言：Python。
- 更新：2026-08-14T22:49:37Z；topics：agentic, agentic-agi, agents, ai, autogen, autogen-ecosystem, chatgpt, framework, llm-agent, llm-framework。
- 摘要：A programming framework for agentic AI
- 增长：14；依据：direct watched repo fallback vs most recent snapshot，非完整全网日增。
...
| stars / forks | 60424 / 9106 |
| language | Python |
| updated_at | 2026-08-14T22:49:37Z |
| 原文 | https://github.com/microsoft/autogen |
