...
## 一句话结论
google-gemini/gemini-cli 是今日 AI Radar watched-repo 信号之一；在 GitHub Search 受限时用于维持 AI Infra / Loop Engineering / Point Rummy 的连续观察基线。

## TL;DR
- Stars：106523；Forks：14441；语言：TypeScript。
- 更新：2026-08-15T00:53:41Z；topics：ai, ai-agents, cli, gemini, gemini-api, mcp-client, mcp-server。
- 摘要：An open-source AI agent that brings the power of Gemini directly into your terminal.
- 增长：12；依据：direct watched repo fallback vs most recent snapshot，非完整全网日增。
...
| stars / forks | 106523 / 14441 |
| language | TypeScript |
| updated_at | 2026-08-15T00:53:41Z |
| 原文 | https://github.com/google-gemini/gemini-cli |
