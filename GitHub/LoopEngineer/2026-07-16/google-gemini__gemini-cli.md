...
Google Gemini 终端 agent，topics 覆盖 MCP client/server，适合观察开放工具链。

## TL;DR

- stars / forks：106008 / 14269。
- 语言：TypeScript；最近更新：2026-07-15T23:51:09Z。
...
| forks | 14269 |
| language | TypeScript |
| updated_at | 2026-07-15T23:51:09Z |
...
Google Gemini 终端 agent，topics 覆盖 MCP client/server，适合观察开放工具链。 对用户的价值不在“star 数本身”，而在它暴露的工程接口、调度/执行模式、工具边界和社区采用速度。今天的采集因 GitHub Search 403，采用 watched repo direct fallback；这能保证核心项目不断档，但不能代表完整趋势排名。
