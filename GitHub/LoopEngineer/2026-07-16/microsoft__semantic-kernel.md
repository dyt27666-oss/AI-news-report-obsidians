...
企业 LLM app/agent SDK，适合插件化、memory、function calling 与 orchestration。

## TL;DR

- stars / forks：28316 / 4678。
- 语言：C#；最近更新：2026-07-15T20:34:47Z。
...
| forks | 4678 |
| language | C# |
| updated_at | 2026-07-15T20:34:47Z |
...
企业 LLM app/agent SDK，适合插件化、memory、function calling 与 orchestration。 对用户的价值不在“star 数本身”，而在它暴露的工程接口、调度/执行模式、工具边界和社区采用速度。今天的采集因 GitHub Search 403，采用 watched repo direct fallback；这能保证核心项目不断档，但不能代表完整趋势排名。
