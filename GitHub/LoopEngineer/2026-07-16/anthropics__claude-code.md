...
Anthropic 终端 coding agent，是 CLI/TUI、权限模式、repo 内 agent loop 的关键观察源。

## TL;DR

- stars / forks：137992 / 22251。
- 语言：Python；最近更新：2026-07-16T01:03:23Z。
...
| forks | 22251 |
| language | Python |
| updated_at | 2026-07-16T01:03:23Z |
| topics | 无 |
| 原文 | https://github.com/anthropics/claude-code |
...
Anthropic 终端 coding agent，是 CLI/TUI、权限模式、repo 内 agent loop 的关键观察源。 对用户的价值不在“star 数本身”，而在它暴露的工程接口、调度/执行模式、工具边界和社区采用速度。今天的采集因 GitHub Search 403，采用 watched repo direct fallback；这能保证核心项目不断档，但不能代表完整趋势排名。
