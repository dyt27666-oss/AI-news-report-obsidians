...
## 一句话结论
终端 coding agent 主线项目，重点观察 CLI/TUI、权限、MCP、上下文与远程执行。

## TL;DR
- stars/forks：27532 / 2970；语言：TypeScript；更新时间：2026-09-01T00:55:56Z。
...
| forks | 2970 |
| language | TypeScript |
| updated_at | 2026-09-01T00:55:56Z |
...
## 专业解读
终端 coding agent 主线项目，重点观察 CLI/TUI、权限、MCP、上下文与远程执行。 对 AI Infra 工程师的关键不是 star 数本身，而是它是否提供可复现的接口、benchmark、release 节奏和可组合的 runtime/agent loop。今日 GitHub Search 受限，因此该详情页明确以 direct watched repo fallback 为 provenance。
