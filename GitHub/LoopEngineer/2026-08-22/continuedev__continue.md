...
> 原文：[continuedev/continue](https://github.com/continuedev/continue)

## 一句话结论
open-source coding agent 这是 `LoopEngineer` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：35578 / 5264；语言：TypeScript。
- 最近更新：2026-08-21T23:07:32Z；topics：agent, ai, cli, developer-tools, open-source。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：14。
...
| forks | 5264 |
| language | TypeScript |
| updated_at | 2026-08-21T23:07:32Z |
| pushed_at | 2026-08-20T10:27:05Z |
...
| AI Infra / Agent 相关性 | open-source coding agent | 可转化为 serving、agent loop 或 evaluator 设计线索 |
