...
> 原文：[OpenHands/OpenHands](https://github.com/OpenHands/OpenHands)

## 一句话结论
🙌 OpenHands: AI-Driven Development 这是 `LoopEngineer` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：84739 / 11045；语言：TypeScript。
- 最近更新：2026-08-22T00:55:21Z；topics：agent, artificial-intelligence, chatgpt, claude-ai, cli, developer-tools, gpt, llm。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：110。
...
| forks | 11045 |
| language | TypeScript |
| updated_at | 2026-08-22T00:55:21Z |
| pushed_at | 2026-08-21T22:02:27Z |
...
| AI Infra / Agent 相关性 | 🙌 OpenHands: AI-Driven Development | 可转化为 serving、agent loop 或 evaluator 设计线索 |
