...
> 原文：[cline/cline](https://github.com/cline/cline)

## 一句话结论
Autonomous coding agent as an SDK, IDE extension, or CLI assistant. 这是 `LoopEngineer` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：66619 / 7179；语言：TypeScript。
- 最近更新：2026-08-22T00:47:32Z；topics：无。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：62。
...
| forks | 7179 |
| language | TypeScript |
| updated_at | 2026-08-22T00:47:32Z |
| pushed_at | 2026-08-22T00:59:47Z |
| topics | 无 |
...
| AI Infra / Agent 相关性 | Autonomous coding agent as an SDK, IDE extension, or CLI assistant. | 可转化为 serving、agent loop 或 evaluator 设计线索 |
