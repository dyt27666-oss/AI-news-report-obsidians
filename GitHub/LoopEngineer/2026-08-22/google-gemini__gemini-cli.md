...
> 原文：[google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli)

## 一句话结论
An open-source AI agent that brings the power of Gemini directly into your terminal. 这是 `LoopEngineer` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：106607 / 14458；语言：TypeScript。
- 最近更新：2026-08-21T23:55:49Z；topics：ai, ai-agents, cli, gemini, gemini-api, mcp-client, mcp-server。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：10。
...
| forks | 14458 |
| language | TypeScript |
| updated_at | 2026-08-21T23:55:49Z |
| pushed_at | 2026-08-22T01:01:23Z |
...
| AI Infra / Agent 相关性 | An open-source AI agent that brings the power of Gemini directly into your terminal. | 可转化为 serving、agent loop 或 evaluator 设计线索 |
