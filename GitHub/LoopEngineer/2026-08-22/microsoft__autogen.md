...
> 原文：[microsoft/autogen](https://github.com/microsoft/autogen)

## 一句话结论
A programming framework for agentic AI 这是 `LoopEngineer` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：60565 / 9129；语言：Python。
- 最近更新：2026-08-21T23:39:20Z；topics：agentic, agentic-agi, agents, ai, autogen, autogen-ecosystem, chatgpt, framework。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：20。
...
| forks | 9129 |
| language | Python |
| updated_at | 2026-08-21T23:39:20Z |
...
| AI Infra / Agent 相关性 | A programming framework for agentic AI | 可转化为 serving、agent loop 或 evaluator 设计线索 |
