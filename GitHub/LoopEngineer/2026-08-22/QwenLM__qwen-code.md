...
> 原文：[QwenLM/qwen-code](https://github.com/QwenLM/qwen-code)

## 一句话结论
An open-source AI coding agent that lives in your terminal. 这是 `LoopEngineer` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：27276 / 2906；语言：TypeScript。
- 最近更新：2026-08-22T00:54:09Z；topics：agentic, ai, ai-agent, ai-coding, cli, coding-agent, developer-tools, llm。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：47。
...
| forks | 2906 |
| language | TypeScript |
| updated_at | 2026-08-22T00:54:09Z |
| pushed_at | 2026-08-22T01:04:35Z |
...
| AI Infra / Agent 相关性 | An open-source AI coding agent that lives in your terminal. | 可转化为 serving、agent loop 或 evaluator 设计线索 |
