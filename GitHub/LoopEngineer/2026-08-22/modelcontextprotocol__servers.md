...
> 原文：[modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers)

## 一句话结论
Model Context Protocol Servers 这是 `LoopEngineer` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：89759 / 11496；语言：TypeScript。
- 最近更新：2026-08-22T00:41:57Z；topics：无。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：37。
...
| forks | 11496 |
| language | TypeScript |
| updated_at | 2026-08-22T00:41:57Z |
...
| AI Infra / Agent 相关性 | Model Context Protocol Servers | 可转化为 serving、agent loop 或 evaluator 设计线索 |
