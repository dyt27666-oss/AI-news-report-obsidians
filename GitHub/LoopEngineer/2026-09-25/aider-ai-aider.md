...
## 一句话结论
Aider-AI/aider 今日作为 `direct watched repo fallback，非完整全网日增；baseline=github-stars-2026-09-24.json` 进入 AI Radar；需要把它当作观察集信号，而不是完整全网排名。

## TL;DR
- Stars / forks：49164 / 4988
- 语言：Python
- 最近更新：2026-09-24T23:53:50Z
- 今日 delta：27
- 摘要：aider is AI pair programming in your terminal

## 元信息表
| 字段 | 值 |
|---|---|
| repo | `Aider-AI/aider` |
| topics | anthropic, chatgpt, claude-3, cli, command-line, gemini, gpt-3, gpt-35-turbo, gpt-4, gpt-4 |
