# google-gemini/gemini-cli - 2026-07-10

## 一句话结论
Gemini CLI 继续验证 open-source terminal agent 路线，可与 Claude Code/Codex 对比 sandbox、tool calling 和 IDE 生态。

## TL;DR
- repo：[google-gemini/gemini-cli](https://github.com/google-gemini/gemini-cli)
- stars / forks：105871 / 14228
- language：TypeScript
- updated_at：2026-07-10T00:45:53Z
...
## 专业解读
google-gemini/gemini-cli 今天通过 direct GitHub API 进入榜单。由于 GitHub Search 已 403，本页不把它解释成“全网增长最快”，而是把它作为固定 watched repo 观察点。对 AI Infra 工程来说，重点不是单日 star，而是它在 serving、training runtime、agent loop 或工具协议中的位置。
