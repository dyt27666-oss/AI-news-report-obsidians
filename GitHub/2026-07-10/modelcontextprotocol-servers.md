# modelcontextprotocol/servers - 2026-07-10

## 一句话结论
MCP servers 是 agent tool registry 与上下文协议层，影响 coding agent 的工具发现、权限和资源隔离。

## TL;DR
- repo：[modelcontextprotocol/servers](https://github.com/modelcontextprotocol/servers)
- stars / forks：88280 / 11191
- language：TypeScript
- updated_at：2026-07-10T00:54:47Z
...
## 专业解读
modelcontextprotocol/servers 今天通过 direct GitHub API 进入榜单。由于 GitHub Search 已 403，本页不把它解释成“全网增长最快”，而是把它作为固定 watched repo 观察点。对 AI Infra 工程来说，重点不是单日 star，而是它在 serving、training runtime、agent loop 或工具协议中的位置。
