...
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/f__prompts_chat_2026_06_13.md
> 返回日报：[[Daily/2026-06-13]]

## 一句话结论

f/prompts.chat 今日出现在 AI Radar GitHub Top 10 或增长榜：f.k.a. Awesome ChatGPT Prompts. Share, discover, and collect prompts from the community. Free and open source — self-host for your organization with complete privacy.

## TL;DR

- **它是什么**：GitHub 项目，语言 HTML，stars 163628，forks 21224。
...
|---|---|
| repo | f/prompts.chat |
| stars / forks | 163628 / 21224 |
| language | HTML |
| updated_at | 2026-06-13T01:01:25Z |
| pushed_at | 2026-06-12T04:35:13Z |
| topics | ai, artificial-intelligence, awesome-list, chatgpt, chatgpt-prompts, claude, gemini, gpt, gpt-4, llm, machine-learning, nextjs, open-source, openai, prompt-engineering, prompts, prompts-chat, typescript |
| stars_delta | 38 |
| 增长依据 | historical_snapshot |
| 原文 | [GitHub](https://github.com/f/prompts.chat) |
| 是否值得试用 | 观察/skim |
...
flowchart TB
  subgraph Signal[GitHub 信号]
    S1[Stars: 163628]
    S2[Delta: 38]
    S3[Updated: 2026-06-13T01:01:25Z]
  end
  subgraph Fit[相关性判断]
    F1[Topics / README]
