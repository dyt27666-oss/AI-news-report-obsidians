...
## 一句话结论
vllm-project/vllm 今日作为 `direct watched repo fallback，非完整全网日增；baseline=github-stars-2026-09-24.json` 进入 AI Radar；需要把它当作观察集信号，而不是完整全网排名。

## TL;DR
- Stars / forks：92642 / 22634
- 语言：Python
- 最近更新：2026-09-25T00:39:52Z
- 今日 delta：94
...
| topics | amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, inference, kimi, llama, llm, ll |
