...
## 一句话结论
NVIDIA/TensorRT-LLM 今日作为 `direct watched repo fallback，非完整全网日增；baseline=github-stars-2026-09-23.json` 进入 AI Radar；需要把它当作观察集信号，而不是完整全网排名。

## TL;DR
- Stars / forks：14712 / 2772
- 语言：Python
- 最近更新：2026-09-24T20:26:28Z
- 今日 delta：13
- 摘要：TensorRT LLM provides users with an easy-to-use Python API to define Large Language Models (LLMs) and supports state-of-the-art optimizations to perfo
