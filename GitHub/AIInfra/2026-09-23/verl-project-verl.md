...
## 一句话结论
verl-project/verl 是今日 AI Infra 固定观察集里的高信号项目；在 GitHub Search rate limit 下，使用 direct `/repos` 元数据保持续报。

## TL;DR
- stars：23573；forks：4579；language：Python。
- updated_at：2026-09-23T00:54:05Z。
- topics：未标注。
- 增长依据：direct watched repo fallback，非完整全网日增；baseline=github-stars-2026-09-22.json；stars_delta=54。
...
| 描述 | verl/HybridFlow: A Flexible and Efficient RL Post-Training Framework |
...
| 维度 | 观察点 | 今日判断 |
|---|---|---|
| 活跃度 | updated_at / pushed_at | 2026-09-23T00:54:05Z / 2026-09-22T14:35:02Z |
