...
## 一句话结论
NVIDIA/Megatron-LM 是今日 AI Infra 固定观察集里的高信号项目；在 GitHub Search rate limit 下，使用 direct `/repos` 元数据保持续报。

## TL;DR
- stars：17982；forks：4549；language：Python。
- updated_at：2026-09-22T23:19:18Z。
- topics：large-language-models, model-para, transformers。
- 增长依据：direct watched repo fallback，非完整全网日增；baseline=github-stars-2026-09-22.json；stars_delta=13。
...
| 维度 | 观察点 | 今日判断 |
|---|---|---|
| 活跃度 | updated_at / pushed_at | 2026-09-22T23:19:18Z / 2026-09-23T00:28:32Z |
| 生态位置 | topics / language | large-language-models, model-para, transformers |
