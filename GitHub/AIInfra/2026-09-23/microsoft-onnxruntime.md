...
## 一句话结论
microsoft/onnxruntime 是今日 AI Infra 固定观察集里的高信号项目；在 GitHub Search rate limit 下，使用 direct `/repos` 元数据保持续报。

## TL;DR
- stars：21910；forks：4244；language：C++。
- updated_at：2026-09-23T01:04:07Z。
...
- 增长依据：direct watched repo fallback，非完整全网日增；baseline=github-stars-2026-09-22.json；stars_delta=7。
...
| 维度 | 观察点 | 今日判断 |
|---|---|---|
| 活跃度 | updated_at / pushed_at | 2026-09-23T01:04:07Z / 2026-09-23T00:58:36Z |
| 生态位置 | topics / language | ai-framework, deep-learning, hardware-acceleration, machine-learning, neural-networks, onnx, pytorch, scikit-learn, ten… |
