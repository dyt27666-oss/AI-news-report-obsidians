...
> 一句话结论：google-gemini/gemini-cli 是今日 AI Radar 通过 GitHub API/快照保留的 AI 基础设施项目，当前 stars=106700、forks=14490，需要结合代码活跃度与 benchmark 决定是否试用。
...
- 语言：TypeScript
- stars / forks：106700 / 14490
- updated_at：2026-08-27T01:03:02Z
- pushed_at：2026-08-26T19:13:14Z
...
flowchart TB
  ...
  subgraph System[项目核心信号]
    ...
    S2[社区信号: stars/forks]
    S3[主题: ai, ai-agents, cli, gemini, gemini-api, mcp-client, mcp-serv]
...
An open-source AI agent that brings the power of Gemini directly into your terminal.。对 AI Infra 工程师来说，核心不是 star 数本身，而是它是否暴露了可复用的 runtime、scheduler、agent loop、benchmark 或数据面/控制面设计。今天 GitHub Search API 出现 403，因此本页把该 repo 作为 watched snapshot/fallback 项处理：适合做连续跟踪，不适合宣称为全网今日增长冠军。
...
1. 社区热度：stars=106700，forks=14490。
2. 活跃度：updated_at=2026-08-27T01:03:02Z，pushed_at=2026-08-26T19:13:14Z。
3. 主题相关性：ai, ai-agents, cli, gemini, gemini-api, mcp-client, mcp-server。
