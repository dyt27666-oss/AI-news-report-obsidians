...
> 一句话结论：sgl-project/sglang 是今日 AI Radar 通过 GitHub API/快照保留的 AI 基础设施项目，当前 stars=32505、forks=8238，需要结合代码活跃度与 benchmark 决定是否试用。
...
- 语言：Python
- stars / forks：32505 / 8238
- updated_at：2026-08-27T01:04:37Z
- pushed_at：2026-08-27T01:05:56Z
...
flowchart TB
  ...
  subgraph System[项目核心信号]
    ...
    S2[社区信号: stars/forks]
    S3[主题: attention, blackwell, cuda, deepseek, diffusion, glm, gpt-os]
...
SGLang is a high-performance serving framework for large language models and multimodal models.。对 AI Infra 工程师来说，核心不是 star 数本身，而是它是否暴露了可复用的 runtime、scheduler、agent loop、benchmark 或数据面/控制面设计。今天 GitHub Search API 出现 403，因此本页把该 repo 作为 watched snapshot/fallback 项处理：适合做连续跟踪，不适合宣称为全网今日增长冠军。
...
1. 社区热度：stars=32505，forks=8238。
2. 活跃度：updated_at=2026-08-27T01:04:37Z，pushed_at=2026-08-27T01:05:56Z。
3. 主题相关性：attention, blackwell, cuda, deepseek, diffusion, glm, gpt-oss, inference, llama, llm, minimax, moe, qwen, qwen-image, reinforcement-learning, transformer, vlm, wan。
