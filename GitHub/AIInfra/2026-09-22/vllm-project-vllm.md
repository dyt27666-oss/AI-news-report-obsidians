...
## 一句话结论
vllm-project/vllm 是今日 AI Radar 关注的项目；本页基于 GitHub 元数据与历史 snapshot，用于判断是否值得试用或跟踪。

## TL;DR
- stars / forks：92365 / 22489
- language：Python
- updated_at：2026-09-22T00:31:33Z
- topics：amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, inference, kimi, llama, llm, llm-serving, model-serving, moe, openai, pytorch, qwen, qwen3, tpu, transformer
- 描述：A high-throughput and memory-efficient inference and serving engine for LLMs
- 今日增长依据：direct watched repo fallback，非完整全网日增；stars_delta=104
...
flowchart TB
  ...
  subgraph Repo[GitHub 项目]
    ...
    R2[语言: Python]
    R3[stars: 92365]
    R4[topics: amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, i]
  end
...
## 相关链接
- 原文：https://github.com/vllm-project/vllm
- GitHub 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/AIInfra/2026-09-22/vllm-project-vllm.md
