...
## 一句话结论
NVIDIA/TensorRT-LLM 是今日 AI Radar 关注的项目；本页基于 GitHub 元数据与历史 snapshot，用于判断是否值得试用或跟踪。

## TL;DR
- stars / forks：14689 / 2767
- language：Python
- updated_at：2026-09-22T00:06:33Z
...
flowchart TB
  ...
  subgraph Repo[GitHub 项目]
    R1[NVIDIA/TensorRT-LLM]
    R2[语言: Python]
    R3[stars: 14689]
    R4[topics: blackwell, cuda, llm-serving, moe, pytorch]
  end
...
## 相关链接
- 原文：https://github.com/NVIDIA/TensorRT-LLM
- GitHub 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/AIInfra/2026-09-22/nvidia-tensorrt-llm.md
