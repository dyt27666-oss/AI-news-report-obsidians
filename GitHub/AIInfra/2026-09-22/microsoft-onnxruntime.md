...
## 一句话结论
microsoft/onnxruntime 是今日 AI Radar 关注的项目；本页基于 GitHub 元数据与历史 snapshot，用于判断是否值得试用或跟踪。

## TL;DR
- stars / forks：21903 / 4240
- language：C++
- updated_at：2026-09-22T00:09:03Z
...
flowchart TB
  ...
  subgraph Repo[GitHub 项目]
    R1[microsoft/onnxruntime]
    R2[语言: C++]
    R3[stars: 21903]
    R4[topics: ai-framework, deep-learning, hardware-acceleration, machine-]
  end
...
## 相关链接
- 原文：https://github.com/microsoft/onnxruntime
- GitHub 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/AIInfra/2026-09-22/microsoft-onnxruntime.md
