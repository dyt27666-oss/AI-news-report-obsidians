...
## 一句话结论
sgl-project/sglang 是今日 AI Radar 关注的项目；本页基于 GitHub 元数据与历史 snapshot，用于判断是否值得试用或跟踪。

## TL;DR
- stars / forks：36275 / 9039
- language：Python
- updated_at：2026-09-22T01:02:29Z
...
- 今日增长依据：direct watched repo fallback，非完整全网日增；stars_delta=56
...
flowchart TB
  ...
  subgraph Repo[GitHub 项目]
    ...
    R2[语言: Python]
    R3[stars: 36275]
    R4[topics: attention, blackwell, cuda, deepseek, diffusion, glm, gpt-os]
  end
...
## 相关链接
- 原文：https://github.com/sgl-project/sglang
- GitHub 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/AIInfra/2026-09-22/sgl-project-sglang.md
