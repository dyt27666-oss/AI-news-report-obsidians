...
## 一句话结论
vllm-project/vllm 是今日 AI Radar 的 fallback 观察项；对 AI Infra / agent loop / RL 工程的价值主要在于：A high-throughput and memory-efficient inference and serving engine for LLMs。

## TL;DR
- Stars / Forks：91191 / 21861
- 语言：Python
- 更新时间：2026-09-08T01:07:53Z
- Topics：amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, inference, kimi, llama, llm, llm-serving, model-serving, moe, openai, pytorch, qwen, qwen3, tpu, transformer
- 增长：277；依据：current/direct metadata vs github-stars-2026-09-04.json，非完整全网日增
...
| pushed_at | 2026-09-08T01:07:30Z |
| topics | amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, inference, kimi, llama, llm, llm-serving, model-serving, moe, openai, pytorch, qwen, qwen3, tpu, transformer |
