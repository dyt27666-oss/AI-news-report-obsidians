...
| 字段 | 值 |
|---|---|
| 条目 | modelcontextprotocol-servers |
| 日期 | 2026-08-29 |
| 所属路径 | GitHub/AIInfra/2026-08-29/modelcontextprotocol-servers |
...
flowchart TB
  ...
  subgraph Detail[详情页]
    N1[modelcontextprotocol-servers]
    N2[TLDR]
    N3[元信息]
    N4[后续动作]
  end
...
## 相关链接
- 日报：[[Daily/2026-08-29]]
- 原始线索：https://github.com/modelcontextprotocol/servers
