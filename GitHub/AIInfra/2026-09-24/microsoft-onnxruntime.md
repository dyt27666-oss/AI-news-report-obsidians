...
> 日期：2026-09-24  
> 类型：GitHub / LLM Serving / Inference  
> 原文：https://github.com/microsoft/onnxruntime

## 一句话结论
microsoft/onnxruntime 今日作为 `LLM Serving / Inference` 固定观察项进入 AI Radar；由于 GitHub Search 403，本页来自 direct watched repo fallback，增长不代表完整全网日增。

## TL;DR
- stars / forks：21920 / 4249
- language：C++
- updated_at：2026-09-24T00:37:52Z
...
flowchart TB
  ...
  subgraph System[microsoft/onnxruntime]
    S1[核心能力]
    S2[Runtime / API]
    S3[状态 / 上下文 / 缓存]
...
| 维度 | 判断 | 跟进动作 |
|---|---|---|
| AI Infra 相关性 | LLM Serving / Inference | 阅读 README / release / benchmark |
