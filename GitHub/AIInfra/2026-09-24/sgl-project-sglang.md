...
## 一句话结论
sgl-project/sglang 今日作为 `LLM Serving / Inference` 固定观察项进入 AI Radar；由于 GitHub Search 403，本页来自 direct watched repo fallback，增长不代表完整全网日增。

## TL;DR
- stars / forks：36381 / 9101
- language：Python
- updated_at：2026-09-24T00:54:03Z
