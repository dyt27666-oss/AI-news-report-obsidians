...
| forks | 28698 |
| language | Python |
| updated_at | 2026-08-04T00:31:43Z |
...
| 维度 | 观察 | 判断 |
|---|---|---|
| 工程相关性 | Tensors and Dynamic neural networks in Python with strong GPU acceleration | 强相关，可作为今日 watchlist |
