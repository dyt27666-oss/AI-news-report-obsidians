...
## 一句话结论
pytorch/pytorch 是今日 AI Radar watched-repo 信号之一；在 GitHub Search 受限时用于维持 AI Infra / Loop Engineering / Point Rummy 的连续观察基线。

## TL;DR
- Stars：102379；Forks：28871；语言：Python。
- 更新：2026-08-15T01:04:55Z；topics：autograd, deep-learning, gpu, machine-learning, neural-network, numpy, python, tensor。
- 摘要：Tensors and Dynamic neural networks in Python with strong GPU acceleration
- 增长：20；依据：direct watched repo fallback vs most recent snapshot，非完整全网日增。
...
| stars / forks | 102379 / 28871 |
| language | Python |
| updated_at | 2026-08-15T01:04:55Z |
| 原文 | https://github.com/pytorch/pytorch |
