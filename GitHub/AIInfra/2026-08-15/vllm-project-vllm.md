...
## 一句话结论
vllm-project/vllm 是今日 AI Radar watched-repo 信号之一；在 GitHub Search 受限时用于维持 AI Infra / Loop Engineering / Point Rummy 的连续观察基线。

## TL;DR
- Stars：89065；Forks：20699；语言：Python。
- 更新：2026-08-15T00:42:13Z；topics：amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, inference, kimi, llama, llm, llm-serving, model-serving, moe, openai, pytorch, qwen, qwen3, tpu, transformer。
- 摘要：A high-throughput and memory-efficient inference and serving engine for LLMs
- 增长：71；依据：direct watched repo fallback vs most recent snapshot，非完整全网日增。
...
| stars / forks | 89065 / 20699 |
| language | Python |
| updated_at | 2026-08-15T00:42:13Z |
| 原文 | https://github.com/vllm-project/vllm |
