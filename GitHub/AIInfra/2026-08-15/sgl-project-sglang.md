...
## 一句话结论
sgl-project/sglang 是今日 AI Radar watched-repo 信号之一；在 GitHub Search 受限时用于维持 AI Infra / Loop Engineering / Point Rummy 的连续观察基线。

## TL;DR
- Stars：31818；Forks：7888；语言：Python。
- 更新：2026-08-15T00:29:03Z；topics：attention, blackwell, cuda, deepseek, diffusion, glm, gpt-oss, inference, llama, llm, minimax, moe, qwen, qwen-image, reinforcement-learning, transformer, vlm, wan。
- 摘要：SGLang is a high-performance serving framework for large language models and multimodal models.
- 增长：60；依据：direct watched repo fallback vs most recent snapshot，非完整全网日增。
...
| stars / forks | 31818 / 7888 |
| language | Python |
| updated_at | 2026-08-15T00:29:03Z |
| 原文 | https://github.com/sgl-project/sglang |
