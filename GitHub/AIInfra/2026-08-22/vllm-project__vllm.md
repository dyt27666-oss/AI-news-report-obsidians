...
## 一句话结论
A high-throughput and memory-efficient inference and serving engine for LLMs 这是 `AIInfra` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：89660 / 21024；语言：Python。
- 最近更新：2026-08-22T00:53:10Z；topics：amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, inference。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：93。
...
| forks | 21024 |
| language | Python |
| updated_at | 2026-08-22T00:53:10Z |
| pushed_at | 2026-08-22T00:47:52Z |
...
| AI Infra / Agent 相关性 | A high-throughput and memory-efficient inference and serving engine for LLMs | 可转化为 serving、agent loop 或 evaluator 设计线索 |
