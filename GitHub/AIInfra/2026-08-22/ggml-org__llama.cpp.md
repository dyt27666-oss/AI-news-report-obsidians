...
> 原文：[ggml-org/llama.cpp](https://github.com/ggml-org/llama.cpp)

## 一句话结论
LLM inference in C/C++ 这是 `AIInfra` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：125050 / 22001；语言：C++。
- 最近更新：2026-08-22T01:02:15Z；topics：ggml。
- 增长依据：direct watched repo fallback；无历史 baseline；非完整全网日增；stars_delta：None。
...
| forks | 22001 |
| language | C++ |
| updated_at | 2026-08-22T01:02:15Z |
| pushed_at | 2026-08-22T00:16:31Z |
| topics | ggml |
...
| AI Infra / Agent 相关性 | LLM inference in C/C++ | 可转化为 serving、agent loop 或 evaluator 设计线索 |
