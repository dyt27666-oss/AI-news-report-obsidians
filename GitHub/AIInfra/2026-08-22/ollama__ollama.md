...
## 一句话结论
Get up and running with Kimi-K2.6, GLM-5.2, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models. 这是 `AIInfra` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：179130 / 17511；语言：Go。
- 最近更新：2026-08-22T00:44:54Z；topics：deepseek, gemma, gemma3, glm, go, golang, gpt-oss, llama。
- 增长依据：historical_snapshot + direct watched repo fallback；非完整全网日增；stars_delta：66。
...
| forks | 17511 |
| language | Go |
| updated_at | 2026-08-22T00:44:54Z |
| pushed_at | 2026-08-22T00:44:46Z |
...
| AI Infra / Agent 相关性 | Get up and running with Kimi-K2.6, GLM-5.2, MiniMax, DeepSeek, gpt-oss, Qwen, Gemma and other models. | 可转化为 serving、agent loop 或 evaluator 设计线索 |
