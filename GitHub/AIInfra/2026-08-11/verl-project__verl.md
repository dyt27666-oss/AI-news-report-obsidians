# verl-project/verl - 2026-08-11

> 一句话结论：`verl-project/verl` 是今日 AI Infra watched fallback 里的高信号项目；由于 GitHub Search 403，本页把它作为可验证 direct `/repos` 信号，而非完整全网排名。

## TL;DR
- Repo：[verl-project/verl](https://github.com/verl-project/verl)
- Stars / Forks：22905 / 4370
- 语言：Python
- 更新时间：2026-08-11T00:40:03Z
...
flowchart TB
  ...
  subgraph System[verl-project/verl]
    S1[核心代码]
    S2[文档/示例]
    S3[Release/Issue 信号]
    S4[社区 stars/forks]
