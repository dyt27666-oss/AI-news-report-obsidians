# NVIDIA/TensorRT-LLM - 2026-08-11

> 一句话结论：`NVIDIA/TensorRT-LLM` 是今日 AI Infra watched fallback 里的高信号项目；由于 GitHub Search 403，本页把它作为可验证 direct `/repos` 信号，而非完整全网排名。

## TL;DR
- Repo：[NVIDIA/TensorRT-LLM](https://github.com/NVIDIA/TensorRT-LLM)
- Stars / Forks：14354 / 2652
- 语言：Python
- 更新时间：2026-08-11T00:31:56Z
- 今日增长：9（direct watched repo fallback vs github-stars-2026-08-10.json; 非完整全网日增）
- 主题：blackwell, cuda, llm-serving, moe, pytorch
...
flowchart TB
  ...
  subgraph System[NVIDIA/TensorRT-LLM]
    S1[核心代码]
    S2[文档/示例]
    S3[Release/Issue 信号]
    S4[社区 stars/forks]
