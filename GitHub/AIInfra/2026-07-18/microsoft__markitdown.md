...
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/AIInfra/2026-07-18/microsoft__markitdown.md
> 返回日报：[[Daily/2026-07-18]]

## 一句话结论

文档转 Markdown 工具，适合 RAG/agent 文件摄取流水线。

## TL;DR

- **它是什么**：microsoft/markitdown 的今日雷达条目。
...
| 字段 | 内容 |
|---|---|
| 发布方/来源 | microsoft/markitdown |
| 栏目/来源类型 | GitHub repo / watched fallback |
| 发布时间 | 2026-07-18 |
| 原文 | [原文](https://github.com/microsoft/markitdown) |
| 代码 | https://github.com/microsoft/markitdown |
| PDF | 未发现 |
| 标签 | #ai-radar |
...
文档转 Markdown 工具，适合 RAG/agent 文件摄取流水线。 该 repo 对今日 AI Infra / coding agent / RL radar 有可行动观察价值。 需要注意：本条目来自自动化雷达采集，若标注为 fallback 或间接扫描，则不能当作完整全网排名，只能当作 watched-source 信号。
