# vllm-project/vllm - 2026-08-25

> 一句话结论：vllm-project/vllm 是今日 AIInfra watched-set 的连续观测项；当前榜单来自 direct/历史 snapshot fallback，适合做趋势跟踪，不等同完整 GitHub 全网榜。

## TL;DR
- Stars：89903；Forks：21136；Language：Python。
- 最近更新：2026-08-25T01:03:28Z；日增：243；依据：direct watched repo fallback / 非完整全网日增。
...
| stars / forks | 89903 / 21136 |
| language | Python |
| topics | amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, inference, kimi, llama, llm, llm-serving, model-serving, moe, openai, pytorch, qwen, qwen3, tpu, transformer |
| updated_at | 2026-08-25T01:03:28Z |
| pushed_at | 2026-08-25T01:02:51Z |
...
## 专业解读
A high-throughput and memory-efficient inference and serving engine for LLMs。对 AI Infra 工程师，重点不是单日 star 数，而是结合 updated_at、release 节奏、issue/PR 活跃度和是否有 benchmark/examples 来判断是否进入 sandbox。
