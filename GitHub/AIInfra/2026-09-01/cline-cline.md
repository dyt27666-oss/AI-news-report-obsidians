...
## 一句话结论
IDE/扩展型 coding agent，适合观察 agent mode、MCP、review loop 与上下文工程。

## TL;DR
- stars/forks：67247 / 7263；语言：TypeScript；更新时间：2026-09-01T00:46:51Z。
...
| forks | 7263 |
| language | TypeScript |
| updated_at | 2026-09-01T00:46:51Z |
| topics | 未标注 |
| 原文 | https://github.com/cline/cline |
...
## 专业解读
IDE/扩展型 coding agent，适合观察 agent mode、MCP、review loop 与上下文工程。 对 AI Infra 工程师的关键不是 star 数本身，而是它是否提供可复现的接口、benchmark、release 节奏和可组合的 runtime/agent loop。今日 GitHub Search 受限，因此该详情页明确以 direct watched repo fallback 为 provenance。
