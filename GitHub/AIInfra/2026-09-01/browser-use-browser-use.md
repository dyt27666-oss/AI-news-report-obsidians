...
## TL;DR
- stars/forks：111864 / 12282；语言：Python；更新时间：2026-09-01T00:54:37Z。
...
| forks | 12282 |
| language | Python |
| updated_at | 2026-09-01T00:54:37Z |
...
## 专业解读
🌐 Make websites accessible for AI agents. Automate tasks online with ease. 对 AI Infra 工程师的关键不是 star 数本身，而是它是否提供可复现的接口、benchmark、release 节奏和可组合的 runtime/agent loop。今日 GitHub Search 受限，因此该详情页明确以 direct watched repo fallback 为 provenance。
