...
IDE/CLI 自主 coding agent，适合观察 extension、MCP 和 agent SDK 工作流。

## TL;DR

- stars / forks：64699 / 6917。
- 语言：TypeScript；最近更新：2026-07-16T00:55:34Z。
...
| forks | 6917 |
| language | TypeScript |
| updated_at | 2026-07-16T00:55:34Z |
| topics | 无 |
| 原文 | https://github.com/cline/cline |
...
IDE/CLI 自主 coding agent，适合观察 extension、MCP 和 agent SDK 工作流。 对用户的价值不在“star 数本身”，而在它暴露的工程接口、调度/执行模式、工具边界和社区采用速度。今天的采集因 GitHub Search 403，采用 watched repo direct fallback；这能保证核心项目不断档，但不能代表完整趋势排名。
