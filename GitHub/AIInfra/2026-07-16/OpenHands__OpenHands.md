...
开源 AI coding workspace，可参考 sandbox、tool loop、workspace harness 与 eval。

## TL;DR

- stars / forks：80904 / 10340。
- 语言：Python；最近更新：2026-07-16T00:24:09Z。
...
| forks | 10340 |
| language | Python |
| updated_at | 2026-07-16T00:24:09Z |
...
开源 AI coding workspace，可参考 sandbox、tool loop、workspace harness 与 eval。 对用户的价值不在“star 数本身”，而在它暴露的工程接口、调度/执行模式、工具边界和社区采用速度。今天的采集因 GitHub Search 403，采用 watched repo direct fallback；这能保证核心项目不断档，但不能代表完整趋势排名。
