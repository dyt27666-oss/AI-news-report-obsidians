...
MCP server 生态入口，影响 coding agent 的工具接入标准和权限边界。

## TL;DR

- stars / forks：88514 / 11227。
- 语言：TypeScript；最近更新：2026-07-15T21:57:52Z。
...
| forks | 11227 |
| language | TypeScript |
| updated_at | 2026-07-15T21:57:52Z |
| topics | 无 |
| 原文 | https://github.com/modelcontextprotocol/servers |
...
MCP server 生态入口，影响 coding agent 的工具接入标准和权限边界。 对用户的价值不在“star 数本身”，而在它暴露的工程接口、调度/执行模式、工具边界和社区采用速度。今天的采集因 GitHub Search 403，采用 watched repo direct fallback；这能保证核心项目不断档，但不能代表完整趋势排名。
