# Post-training watchlist: verl / OpenRLHF
...
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/AIInfra/2026-07-17/post-training-watchlist.md
> 返回日报：[[Daily/2026-07-17]]

## 一句话结论

verl 与 OpenRLHF 继续构成 GRPO/PPO/post-training 工程观察线。

## TL;DR

- **它是什么**：ByteDance / OpenRLHF 的今日雷达条目。
- **为什么重要**：对 RLHF/RLAIF、rollout、reward、Ray/vLLM 训练管线有直接参考。
...
| 字段 | 内容 |
|---|---|
| 发布方/来源 | ByteDance / OpenRLHF |
| 栏目/来源类型 | GitHub / RLHF |
| 作者/机构 | ByteDance / OpenRLHF |
| 发布时间 | 2026-07-17 |
| 原文 | [原文](https://github.com/volcengine/verl) |
...
verl 与 OpenRLHF 继续构成 GRPO/PPO/post-training 工程观察线。 对 RLHF/RLAIF、rollout、reward、Ray/vLLM 训练管线有直接参考。 若标注为 fallback 或间接扫描，则不能当作完整全网排名，只能当作 watched-source 信号。
