...
## 一句话结论
sgl-project/sglang 是今日 AIInfra watchlist 的关键节点；当前数据适合用于工程跟踪，不应解读为完整 GitHub 全站排名。

## TL;DR
- Stars/Forks：30976 / 7528；语言：Python。
- 最近更新：2026-07-31T00:50:26Z；topics：attention, blackwell, cuda, deepseek, diffusion, glm, gpt-oss, inference, llama, llm。
...
| forks | 7528 |
| language | Python |
| updated_at | 2026-07-31T00:50:26Z |
| stars_delta | 43 |
...
flowchart TB
  ...
  subgraph System[仓库能力]
    ...
    S2[README / examples]
    S3[issues / releases]
    S4[topics: attention, blackwell, cuda, deepseek, diffusion, glm, gpt-os]
  end
