...
## 一句话结论
vllm-project/vllm 是今日 AIInfra watchlist 的关键节点；当前数据适合用于工程跟踪，不应解读为完整 GitHub 全站排名。

## TL;DR
- Stars/Forks：87723 / 20070；语言：Python。
- 最近更新：2026-07-31T01:04:29Z；topics：amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, inference, kimi, llama。
...
| forks | 20070 |
| language | Python |
| updated_at | 2026-07-31T01:04:29Z |
| stars_delta | 121 |
...
flowchart TB
  ...
  subgraph System[仓库能力]
    ...
    S2[README / examples]
    S3[issues / releases]
    S4[topics: amd, blackwell, cuda, deepseek, deepseek-v3, gpt, gpt-oss, i]
  end
