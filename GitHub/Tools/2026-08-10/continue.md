# Continue - Coding 工具更新 (2026-08-10)

## 一句话结论
Continue 今天进入 Coding 工具扫描矩阵；release/tag=v2.0.0-vscode，用于观察 CLI/TUI、agent mode、MCP、权限和 IDE 集成变化。
...
| 发布时间或 tag | 2026-06-19T00:24:01Z / v2.0.0-vscode |
| 原文链接 | https://github.com/continuedev/continue/releases/tag/v2.0.0-vscode |
| Docs/Changelog | https://github.com/continuedev/continue/releases |
...
- 文档：https://github.com/continuedev/continue/releases
