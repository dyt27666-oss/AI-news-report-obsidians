# OpenAI Codex - Coding 工具更新 (2026-08-10)

## 一句话结论
OpenAI Codex 今天进入 Coding 工具扫描矩阵；release/tag=rust-v0.147.0，用于观察 CLI/TUI、agent mode、MCP、权限和 IDE 集成变化。
...
| 发布时间或 tag | 2026-08-07T01:41:49Z / rust-v0.147.0 |
| 原文链接 | https://github.com/openai/codex/releases/tag/rust-v0.147.0 |
| Docs/Changelog | https://developers.openai.com/codex/changelog |
...
- 文档：https://developers.openai.com/codex/changelog
