...
## 一句话结论
Qwen coding agent/CLI 生态观察点，关注本地化、多模型和 IDE/终端闭环。

## TL;DR
- stars：27627；forks：2982；language：TypeScript。
- updated_at：2026-09-04T00:10:42Z；growth_basis：direct watched repo fallback vs github-stars-2026-09-03.json，非完整全网日增。
...
| language | TypeScript |
| topics | agentic, ai, ai-agent, ai-coding, cli, coding-agent, developer-tools, llm, mcp, qwen |
...
flowchart TB
  ...
  subgraph System[QwenLM/qwen-code 核心信号]
    S1[Repo metadata]
    S2[README/Topics]
...
## 专业解读
Qwen coding agent/CLI 生态观察点，关注本地化、多模型和 IDE/终端闭环。 今日由于 GitHub Search 403，本页使用 direct `/repos` 元数据维持知识库连续性；它不是全网增长榜，但适合作为固定 watchlist 的真实元数据快照。
