...
> 原文：[https://github.com/cline/cline/releases](https://github.com/cline/cline/releases)

## 一句话结论
Cline 今日保留在 Coding 工具扫描矩阵中；可验证的代表更新为 `Release API 失败` / `需页面核验` / `需页面核验`，重点观察 agent mode、MCP、IDE/CLI、权限模式、上下文窗口、远程执行与 pricing/rate limit。
...
- 官方入口：https://github.com/cline/cline/releases
