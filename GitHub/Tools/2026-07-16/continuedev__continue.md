...
- stars / forks：34904 / 5052。
- 语言：TypeScript；最近更新：2026-07-16T00:00:34Z。
...
| forks | 5052 |
| language | TypeScript |
| updated_at | 2026-07-16T00:00:34Z |
...
开源 coding agent，适合观察 IDE/CLI 结合、模型路由和私有代码库工作流。 对用户的价值不在“star 数本身”，而在它暴露的工程接口、调度/执行模式、工具边界和社区采用速度。今天的采集因 GitHub Search 403，采用 watched repo direct fallback；这能保证核心项目不断档，但不能代表完整趋势排名。
