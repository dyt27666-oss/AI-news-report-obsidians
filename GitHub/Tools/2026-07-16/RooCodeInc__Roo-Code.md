...
IDE agent extension，适合观察多模型路由、MCP、计划/执行模式。

## TL;DR

- stars / forks：24344 / 3367。
- 语言：TypeScript；最近更新：2026-07-15T20:24:23Z。
...
| forks | 3367 |
| language | TypeScript |
| updated_at | 2026-07-15T20:24:23Z |
| topics | 无 |
| 原文 | https://github.com/RooCodeInc/Roo-Code |
...
IDE agent extension，适合观察多模型路由、MCP、计划/执行模式。 对用户的价值不在“star 数本身”，而在它暴露的工程接口、调度/执行模式、工具边界和社区采用速度。今天的采集因 GitHub Search 403，采用 watched repo direct fallback；这能保证核心项目不断档，但不能代表完整趋势排名。
