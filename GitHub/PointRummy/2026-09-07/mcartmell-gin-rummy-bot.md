...
> 一句话结论：`mcartmell/gin-rummy-bot` 今日进入 AI Radar。描述：A web-based Gin Rummy game and AI。stars=4，forks=2，language=Perl，updated_at=20
...
| 日期 | 2026-09-07 |
| 类型 | GitHub |
| 原文 | [link](https://github.com/mcartmell/gin-rummy-bot) |
...
`mcartmell/gin-rummy-bot` 今日进入 AI Radar。描述：A web-based Gin Rummy game and AI。stars=4，forks=2，language=Perl，updated_at=2024-10-30T20:06:17Z。增长依据：direct/current snapshot vs github-stars-2026-09-06.json，非完整全网日增。对用户而言，重点看它是否能复用到 LLM serving/training、agent loop、coding workflow 或 Point Rummy 业务建模。
