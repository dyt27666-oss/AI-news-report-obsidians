...
> 一句话结论：`mudont/indian-rummy` 今日进入 AI Radar。描述：Typescript library for Indian Rummy card game。stars=5，forks=0，language=TypeScript
...
| 日期 | 2026-09-07 |
| 类型 | GitHub |
| 原文 | [link](https://github.com/mudont/indian-rummy) |
...
`mudont/indian-rummy` 今日进入 AI Radar。描述：Typescript library for Indian Rummy card game。stars=5，forks=0，language=TypeScript，updated_at=2025-08-08T21:05:04Z。增长依据：direct/current snapshot vs github-stars-2026-09-06.json，非完整全网日增。对用户而言，重点看它是否能复用到 LLM serving/training、agent loop、coding workflow 或 Point Rummy 业务建模。
