...
> 一句话结论：`nakkekakke/rummy-ai` 今日进入 AI Radar。描述：Text based classic Rummy game with an AI that uses ISMCTS. Data Structures and Al
...
| 日期 | 2026-09-07 |
| 类型 | GitHub |
| 原文 | [link](https://github.com/nakkekakke/rummy-ai) |
