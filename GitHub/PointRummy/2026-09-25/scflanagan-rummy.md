...
## 一句话结论
SCFlanagan/Rummy 今日作为 `direct GET failed；baseline=github-stars-2026-09-24.json` 进入 AI Radar；需要把它当作观察集信号，而不是完整全网排名。
...
## 相关链接
- GitHub：https://github.com/SCFlanagan/Rummy
