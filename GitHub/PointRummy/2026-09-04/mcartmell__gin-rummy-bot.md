...
## TL;DR
- stars：4；forks：2；language：Perl。
- updated_at：2024-10-30T20:06:17Z；growth_basis：2026-09-03/09-02 theme snapshot fallback；今日 GitHub Search 403，非今日实时数据。
...
flowchart TB
  ...
  subgraph System[mcartmell/gin-rummy-bot 核心信号]
    S1[Repo metadata]
    S2[README/Topics]
...
## 专业解读
A web-based Gin Rummy game and AI 今日由于 GitHub Search 403，本页使用 direct `/repos` 元数据维持知识库连续性；它不是全网增长榜，但适合作为固定 watchlist 的真实元数据快照。
