...
- stars / forks：13 / 5。
- 语言：Python；最近更新：2025-03-25T13:47:09Z。
...
A hand-rolled neuroevolution AI for gin rummy. 对用户的价值不在“star 数本身”，而在它暴露的工程接口、调度/执行模式、工具边界和社区采用速度。今天的采集因 GitHub Search 403，采用 watched repo direct fallback；这能保证核心项目不断档，但不能代表完整趋势排名。
