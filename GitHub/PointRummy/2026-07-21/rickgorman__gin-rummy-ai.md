...
| language | Python |
| topics | 无 |
| description | A hand-rolled neuroevolution AI for gin rummy. |
| 原文链接 | [https://github.com/rickgorman/gin-rummy-ai](https://github.com/rickgorman/gin-rummy-ai) |
...
flowchart TB
  ...
  subgraph Project[项目观察]
    P1[rickgorman/gin-rummy-ai]
    P2[Stars 13]
    P3[Language Python]
    P4[Updated 2025-03-25]
  end
...
- GitHub：[https://github.com/rickgorman/gin-rummy-ai](https://github.com/rickgorman/gin-rummy-ai)
