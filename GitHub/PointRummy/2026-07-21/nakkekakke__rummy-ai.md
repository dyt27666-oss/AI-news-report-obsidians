...
| description | Text based classic Rummy game with an AI that uses ISMCTS. Data Structures and Algorithms course project, University of Helsinki |
| 原文链接 | [https://github.com/nakkekakke/rummy-ai](https://github.com/nakkekakke/rummy-ai) |
...
flowchart TB
  ...
  subgraph Project[项目观察]
    P1[nakkekakke/rummy-ai]
    P2[Stars 11]
    P3[Language Java]
    P4[Updated 2026-04-17]
  end
...
- GitHub：[https://github.com/nakkekakke/rummy-ai](https://github.com/nakkekakke/rummy-ai)
