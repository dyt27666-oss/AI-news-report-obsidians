...
| language | JavaScript |
| topics | 无 |
| description | This project is a recreation of the classic card game Rummy. It features an AI player to play against, a hand of cards that can be dragged and sorted, and a scoreboard that keeps track of multiple rounds. |
| 原文链接 | [https://github.com/SCFlanagan/Rummy](https://github.com/SCFlanagan/Rummy) |
...
flowchart TB
  ...
  subgraph Project[项目观察]
    P1[SCFlanagan/Rummy]
    P2[Stars 4]
    P3[Language JavaScript]
    P4[Updated 2025-07-25]
  end
...
- GitHub：[https://github.com/SCFlanagan/Rummy](https://github.com/SCFlanagan/Rummy)
