...
| description | Java-based Gin Rummy console game, with an AI opponent |
| 原文链接 | [https://github.com/jmhummel/Gin-Rummy-Java](https://github.com/jmhummel/Gin-Rummy-Java) |
...
flowchart TB
  ...
  subgraph Project[项目观察]
    P1[jmhummel/Gin-Rummy-Java]
    P2[Stars 8]
    P3[Language Java]
    P4[Updated 2023-08-16]
  end
...
- GitHub：[https://github.com/jmhummel/Gin-Rummy-Java](https://github.com/jmhummel/Gin-Rummy-Java)
