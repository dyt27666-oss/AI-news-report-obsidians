...
| language | Perl |
| topics | 无 |
| description | A web-based Gin Rummy game and AI |
| 原文链接 | [https://github.com/mcartmell/gin-rummy-bot](https://github.com/mcartmell/gin-rummy-bot) |
...
flowchart TB
  ...
  subgraph Project[项目观察]
    P1[mcartmell/gin-rummy-bot]
    P2[Stars 4]
    P3[Language Perl]
    P4[Updated 2024-10-30]
  end
...
- GitHub：[https://github.com/mcartmell/gin-rummy-bot](https://github.com/mcartmell/gin-rummy-bot)
