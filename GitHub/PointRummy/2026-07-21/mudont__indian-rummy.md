...
| language | TypeScript |
| topics | 无 |
| description | Typescript library for Indian Rummy card game |
| 原文链接 | [https://github.com/mudont/indian-rummy](https://github.com/mudont/indian-rummy) |
...
flowchart TB
  ...
  subgraph Project[项目观察]
    P1[mudont/indian-rummy]
    P2[Stars 5]
    P3[Language TypeScript]
    P4[Updated 2025-08-08]
  end
...
- GitHub：[https://github.com/mudont/indian-rummy](https://github.com/mudont/indian-rummy)
