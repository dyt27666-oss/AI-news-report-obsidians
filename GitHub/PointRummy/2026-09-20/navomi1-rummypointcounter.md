# Navomi1/RummyPointCounter

> 一句话结论：Count points while playing Rummy

## TL;DR
- 来源：GitHub direct `/repos` fallback / snapshot。
- Stars/Forks：0 / 0；语言：Swift。
- 更新时间：2026-01-13T23:49:39Z；原文：https://github.com/Navomi1/RummyPointCounter。
- 对 AI Infra/Agent 的意义：用于观察 serving、training、post-training、coding-agent loop 或工具链生态成熟度。

## 元信息表
| 字段 | 值 |
|---|---|
| repo | Navomi1/RummyPointCounter |
| stars | 0 |
| forks | 0 |
| language | Swift |
| topics | 无 |
| source | snapshot/direct |
| 原文 | https://github.com/Navomi1/RummyPointCounter |
