...
## TL;DR
- stars/forks：2 / 1；语言：Python；更新时间：2026-06-27T06:34:26Z。
...
## 专业解读
A Python-based multiplayer Indian Rummy game with support for AI opponents and LAN play. Implements data struc 对 AI Infra 工程师的关键不是 star 数本身，而是它是否提供可复现的接口、benchmark、release 节奏和可组合的 runtime/agent loop。今日 GitHub Search 受限，因此该详情页明确以 direct watched repo fallback 为 provenance。
