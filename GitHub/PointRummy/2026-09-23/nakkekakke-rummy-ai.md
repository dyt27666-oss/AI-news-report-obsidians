...
## 一句话结论
nakkekakke/rummy-ai 是今日 Point Rummy 固定观察集里的高信号项目；在 GitHub Search rate limit 下，使用 direct `/repos` 元数据保持续报。

## TL;DR
- stars：12；forks：5；language：Java。
...
| 维度 | 观察点 | 今日判断 |
|---|---|---|
| 活跃度 | updated_at / pushed_at | 2026-08-27T21:23:08Z / 2019-09-07T14:49:42Z |
| 生态位置 | topics / language | ai, card, card-game, game, ismcts, mcts, monte-carlo-tree-search, rummy |
