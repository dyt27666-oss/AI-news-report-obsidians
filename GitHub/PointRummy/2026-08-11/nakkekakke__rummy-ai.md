# nakkekakke/rummy-ai - 2026-08-11

> 一句话结论：`nakkekakke/rummy-ai` 是今日 Point Rummy / Game AI watched fallback 里的高信号项目；由于 GitHub Search 403，本页把它作为可验证 direct `/repos` 信号，而非完整全网排名。

## TL;DR
- Repo：[nakkekakke/rummy-ai](https://github.com/nakkekakke/rummy-ai)
- Stars / Forks：11 / 5
- 语言：Java
- 更新时间：2026-04-17T10:02:59Z
- 今日增长：0（historical_snapshot）
- 主题：ai, card, card-game, game, ismcts, mcts, monte-carlo-tree-search, rummy
...
flowchart TB
  ...
  subgraph System[nakkekakke/rummy-ai]
    S1[核心代码]
    S2[文档/示例]
    S3[Release/Issue 信号]
    S4[社区 stars/forks]
