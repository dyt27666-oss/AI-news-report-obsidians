...
> 一句话结论：direct GET failed: HTTP Error 403: rate limit exceeded

## TL;DR
- 来源：previous broad fallback，非今日实时数据。
- Stars/Forks：0 / 0；语言：Unknown。
- 更新时间：访问失败；原文：https://github.com/Ductapemaster/RummyAI。
...
| language | Unknown |
| topics | 无 |
| source | previous broad fallback，非今日实时数据 |
