...
> 原文：[dv-rastogi/Rummy](https://github.com/dv-rastogi/Rummy)

## 一句话结论
Variation of classical Indian Rummy made in Pygame 这是 `PointRummy` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：5 / 0；语言：Python。
- 最近更新：2023-09-26T11:21:39Z；topics：无。
...
| AI Infra / Agent 相关性 | Variation of classical Indian Rummy made in Pygame | 可转化为 serving、agent loop 或 evaluator 设计线索 |
