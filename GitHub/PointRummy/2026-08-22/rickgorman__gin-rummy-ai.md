...
> 原文：[rickgorman/gin-rummy-ai](https://github.com/rickgorman/gin-rummy-ai)

## 一句话结论
A hand-rolled neuroevolution AI for gin rummy. 这是 `PointRummy` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：13 / 5；语言：Python。
- 最近更新：2025-03-25T13:47:09Z；topics：无。
...
| AI Infra / Agent 相关性 | A hand-rolled neuroevolution AI for gin rummy. | 可转化为 serving、agent loop 或 evaluator 设计线索 |
