...
> 原文：[jmhummel/Gin-Rummy-Java](https://github.com/jmhummel/Gin-Rummy-Java)

## 一句话结论
Java-based Gin Rummy console game, with an AI opponent 这是 `PointRummy` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：8 / 0；语言：Java。
- 最近更新：2023-08-16T16:12:58Z；topics：ai, artificial-intelligence, card-game, card-games, cardgame, gin, gin-rummy, java。
...
| topics | ai, artificial-intelligence, card-game, card-games, cardgame, gin, gin-rummy, java |
...
| AI Infra / Agent 相关性 | Java-based Gin Rummy console game, with an AI opponent | 可转化为 serving、agent loop 或 evaluator 设计线索 |
