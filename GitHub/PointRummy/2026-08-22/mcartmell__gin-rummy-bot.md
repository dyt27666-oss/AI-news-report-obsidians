...
> 原文：[mcartmell/gin-rummy-bot](https://github.com/mcartmell/gin-rummy-bot)

## 一句话结论
A web-based Gin Rummy game and AI 这是 `PointRummy` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：4 / 2；语言：Perl。
- 最近更新：2024-10-30T20:06:17Z；topics：无。
...
| AI Infra / Agent 相关性 | A web-based Gin Rummy game and AI | 可转化为 serving、agent loop 或 evaluator 设计线索 |
