...
## 一句话结论
Typescript library for Indian Rummy card game 这是 `PointRummy` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：5 / 0；语言：TypeScript。
- 最近更新：2025-08-08T21:05:04Z；topics：无。
...
| AI Infra / Agent 相关性 | Typescript library for Indian Rummy card game | 可转化为 serving、agent loop 或 evaluator 设计线索 |
