...
> 原文：[nakkekakke/rummy-ai](https://github.com/nakkekakke/rummy-ai)

## 一句话结论
Text based classic Rummy game with an AI that uses ISMCTS. Data Structures and Algorithms course project, University ... 这是 `PointRummy` 的固定观察项；今日 GitHub Search 受 403 限流影响，所以本页强调 provenance 与可行动观察，不把它包装成完整全网排名。

## TL;DR
- stars/forks：11 / 5；语言：Java。
- 最近更新：2026-04-17T10:02:59Z；topics：ai, card, card-game, game, ismcts, mcts, monte-carlo-tree-search, rummy。
...
| AI Infra / Agent 相关性 | Text based classic Rummy game with an AI that uses ISMCTS. Data Structures and Algorithms course project, University ... | 可转化为 serving、agent loop 或 evaluator 设计线索 |
