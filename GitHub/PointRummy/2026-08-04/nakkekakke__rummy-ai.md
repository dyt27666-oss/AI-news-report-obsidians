# nakkekakke/rummy-ai - 2026-08-04
...
| 维度 | 观察 | 判断 |
|---|---|---|
| 工程相关性 | Text based classic Rummy game with an AI that uses ISMCTS. Data Structures and Algorithms course project, University of Helsinki | 低置信，需人工复核 |
