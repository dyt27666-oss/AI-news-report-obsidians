...
> 一句话结论：`nakkekakke/rummy-ai` 是今日 PointRummy 观察项；当前采用 GitHub snapshot/direct fallback 元数据，适合先作为工程选型或机制拆解入口。

## TL;DR
- Stars/Forks：12 / 5；语言：Java。
- 更新时间：2026-08-27T21:23:08Z；增长：0（historical_snapshot）。
- 重点：Text based classic Rummy game with an AI that uses ISMCTS. Data Structures and Algorithms course project, University of Helsinki
