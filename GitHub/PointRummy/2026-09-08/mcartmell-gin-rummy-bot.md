...
> 一句话结论：`mcartmell/gin-rummy-bot` 是今日 PointRummy 观察项；当前采用 GitHub snapshot/direct fallback 元数据，适合先作为工程选型或机制拆解入口。

## TL;DR
- Stars/Forks：4 / 2；语言：Perl。
- 更新时间：2024-10-30T20:06:17Z；增长：0（historical_snapshot）。
- 重点：A web-based Gin Rummy game and AI
