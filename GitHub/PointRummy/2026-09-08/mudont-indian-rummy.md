...
> 一句话结论：`mudont/indian-rummy` 是今日 PointRummy 观察项；当前采用 GitHub snapshot/direct fallback 元数据，适合先作为工程选型或机制拆解入口。

## TL;DR
- Stars/Forks：5 / 0；语言：TypeScript。
- 更新时间：2025-08-08T21:05:04Z；增长：0（historical_snapshot）。
