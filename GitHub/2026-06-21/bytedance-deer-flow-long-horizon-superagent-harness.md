...
> 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/2026-06-21/bytedance-deer-flow-long-horizon-superagent-harness.md
> 返回日报：[[Daily/2026-06-21]]

## 一句话结论

deer-flow 今日真实增长 +320 stars，强化了长任务 agent harness 开源化趋势。

## TL;DR

- **它是什么**：字节 / GitHub 的高相关信号，来源类型是 开源项目。
- **为什么重要**：它对应生产 agent 的真实骨架：sandbox、memory、tools、skills、subagents、message gateway、失败恢复。
...
| 作者/机构 | 字节 / GitHub |
| 发布时间 | 2026-06 |
| 原文 | [原文](https://github.com/bytedance/deer-flow) |
| 代码 | https://github.com/bytedance/deer-flow |
| PDF | 未发现 |
| 标签 | #github #agent #long-horizon |
...
flowchart LR
  subgraph Source[发布方与条目]
    C[字节 / GitHub]
    A[ByteDance deer-flow long-horizon Sup]
  end
...
它对应生产 agent 的真实骨架：sandbox、memory、tools、skills、subagents、message gateway、失败恢复。 对 AI Infra 工程师来说，关键不只是“热度”，而是它是否改变生产系统里的约束：请求路由、缓存命中率、工具调用可靠性、评测闭环、训练数据生成、成本结构或硬件路径。
...
#ai-radar #github #agent #long-horizon
