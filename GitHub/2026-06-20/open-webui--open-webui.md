...
## 一句话结论
open-webui/open-webui 是今日 AI Radar GitHub 榜单项目，核心信号是：User-friendly AI Interface (Supports Ollama, OpenAI API, ...)

## TL;DR
- Stars / forks：142291 / 20454；stars_delta：111。
- 语言：Python；更新时间：2026-06-20T00:22:12Z。
- 主题：ai, llm, llm-ui, llm-webui, llms, mcp, ollama, ollama-webui, open-webui, openai, openapi, rag, self-hosted, ui, webui。
...
| Forks | 20454 |
| Language | Python |
| Updated | 2026-06-20T00:22:12Z |
| Pushed | 2026-06-19T23:43:24Z |
| Topics | ai, llm, llm-ui, llm-webui, llms, mcp, ollama, ollama-webui, open-webui, openai, openapi, rag, self-hosted, ui, webui |
| 描述 | User-friendly AI Interface (Supports Ollama, OpenAI API, ...) |
| 网页详情 | [GitHub](https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/2026-06-20/open-webui--open-webui.md) |
...
| 维度 | 观察点 | 当前判断 |
|---|---|---|
| 生态热度 | stars / forks / delta | 142291 stars，delta 111 |
...
## 相关链接
- 原文：[open-webui/open-webui](https://github.com/open-webui/open-webui)
- 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/2026-06-20/open-webui--open-webui.md
- 返回日报：[[Daily/2026-06-20]]
