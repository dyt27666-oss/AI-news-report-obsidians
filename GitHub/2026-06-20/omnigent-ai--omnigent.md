...
original_url: https://github.com/omnigent-ai/omnigent
...
## 一句话结论
omnigent-ai/omnigent 是今日 AI Radar GitHub 榜单项目，核心信号是：Omnigent is an open-source AI agent framework and meta-harness: orchestrate Claude Code, Codex, Cursor, Pi, and custom agents — swap harnesses without rewriting, enforce policies and sandboxing, and collaborate in real time from any device.

## TL;DR
- Stars / forks：4052 / 456；stars_delta：248。
- 语言：Python；更新时间：2026-06-20T00:44:09Z。
- 主题：agent-framework, agent-governance, agent-orchestration, agents, ai, ai-agent, ai-agents, claude-code, codex, coding-agents, developer-tools, llm, ml, multi-agent, python, sandbox。
...
| Forks | 456 |
| Language | Python |
| Updated | 2026-06-20T00:44:09Z |
| Pushed | 2026-06-20T00:14:35Z |
...
| 网页详情 | [GitHub](https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/2026-06-20/omnigent-ai--omnigent.md) |
...
| 维度 | 观察点 | 当前判断 |
|---|---|---|
| 生态热度 | stars / forks / delta | 4052 stars，delta 248 |
...
## 相关链接
- 原文：[omnigent-ai/omnigent](https://github.com/omnigent-ai/omnigent)
- 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/2026-06-20/omnigent-ai--omnigent.md
- 返回日报：[[Daily/2026-06-20]]
