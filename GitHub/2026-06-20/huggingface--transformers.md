...
original_url: https://github.com/huggingface/transformers
...
## 一句话结论
huggingface/transformers 是今日 AI Radar GitHub 榜单项目，核心信号是：🤗 Transformers: the model-definition framework for state-of-the-art machine learning models in text, vision, audio, and multimodal models, for both inference and training. 

## TL;DR
- Stars / forks：161731 / 33552；stars_delta：25。
- 语言：Python；更新时间：2026-06-19T23:33:24Z。
- 主题：audio, deep-learning, deepseek, gemma, glm, hacktoberfest, llm, machine-learning, model-hub, natural-language-processing, nlp, pretrained-models, python, pytorch, pytorch-transformers, qwen, speech-recognition, transformer, vlm。
...
| Forks | 33552 |
| Language | Python |
| Updated | 2026-06-19T23:33:24Z |
| Pushed | 2026-06-19T18:03:02Z |
| Topics | audio, deep-learning, deepseek, gemma, glm, hacktoberfest, llm, machine-learning, model-hub, natural-language-processing, nlp, pretrained-models, python, pytorch, pytorch-transformers, qwen, speech-recognition, transformer, vlm |
| 描述 | 🤗 Transformers: the model-definition framework for state-of-the-art machine learning models in text, vision, audio, and multimodal models, for both inference and training.  |
| 网页详情 | [GitHub](https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/2026-06-20/huggingface--transformers.md) |
...
| 维度 | 观察点 | 当前判断 |
|---|---|---|
| 生态热度 | stars / forks / delta | 161731 stars，delta 25 |
...
## 相关链接
- 原文：[huggingface/transformers](https://github.com/huggingface/transformers)
- 网页详情：https://github.com/dyt27666-oss/AI-news-report-obsidians/blob/main/GitHub/2026-06-20/huggingface--transformers.md
- 返回日报：[[Daily/2026-06-20]]
