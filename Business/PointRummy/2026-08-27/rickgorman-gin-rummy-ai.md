...
> 一句话结论：rickgorman/gin-rummy-ai 是今日 AI Radar 通过 GitHub API/快照保留的 Point Rummy 业务项目，当前 stars=13、forks=5，需要结合代码活跃度与 benchmark 决定是否试用。

## TL;DR

- 来源：GitHub Repository
- 来源类型：GitHub API / star snapshot / direct watched repo fallback
- Repo：[rickgorman/gin-rummy-ai](https://github.com/rickgorman/gin-rummy-ai)
- 语言：Python
- stars / forks：13 / 5
- updated_at：2025-03-25T13:47:09Z
- pushed_at：2017-12-24T22:22:19Z
- topics：未标注
- stars_delta：无可比基线
...
| 字段 | 内容 |
|---|---|
| 项目 | rickgorman/gin-rummy-ai |
| 描述 | A hand-rolled neuroevolution AI for gin rummy. |
...
A hand-rolled neuroevolution AI for gin rummy.。对 AI Infra 工程师来说，核心不是 star 数本身，而是它是否暴露了可复用的 runtime、scheduler、agent loop、benchmark 或数据面/控制面设计。今天 GitHub Search API 出现 403，因此本页把该 repo 作为 watched snapshot/fallback 项处理：适合做连续跟踪，不适合宣称为全网今日增长冠军。
...
1. 社区热度：stars=13，forks=5。
2. 活跃度：updated_at=2025-03-25T13:47:09Z，pushed_at=2017-12-24T22:22:19Z。
3. 主题相关性：未标注。
