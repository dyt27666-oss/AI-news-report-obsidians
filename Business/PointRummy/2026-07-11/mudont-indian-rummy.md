...
mudont/indian-rummy 是低 star 但与 Rummy 规则/AI opponent 相关的候选，可抽取规则、计分、状态动作 schema。

## TL;DR

- 核心信号：mudont/indian-rummy 是低 star 但与 Rummy 规则/AI opponent 相关的候选，可抽取规则、计分、状态动作 schema。
...
mudont/indian-rummy 是低 star 但与 Rummy 规则/AI opponent 相关的候选，可抽取规则、计分、状态动作 schema。 对 AI Infra 工程师的意义在于，它可能改变工具链、模型运行时、agent loop 或业务仿真构建方式。
