# Rummy / imperfect-information paper watchlist

> 一句话结论：今日 Rummy GitHub 信号多于论文信号；论文侧继续观察 imperfect-information card game、ISMCTS/MCTS、belief state、self-play、rule engine benchmar

## TL;DR

- 来源类型：Point Rummy Watchlist
...
|---|---|
| 日期 | 2026-09-07 |
| 类型 | Point Rummy Watchlist |
| 原文 | [link](https://arxiv.org/search/?query=rummy+imperfect+information+game+AI&searchtype=all) |
...
今日 Rummy GitHub 信号多于论文信号；论文侧继续观察 imperfect-information card game、ISMCTS/MCTS、belief state、self-play、rule engine benchmark。
